...
Program SPhenoTHDMIIIHB 
 
Use Control
Use InputOutput_THDMIIIHB
Use LoopFunctions
Use Settings
Use RunSM_THDMIIIHB
Use LowEnergy_THDMIIIHB
Use FlavorKit_LFV_THDMIIIHB
Use FlavorKit_QFV_THDMIIIHB
Use FlavorKit_Observables_THDMIIIHB
Use Mathematics
Use Model_Data_THDMIIIHB
Use Tadpoles_THDMIIIHB 
 !Use StandardModel
Use Boundaries_THDMIIIHB
 Use HiggsCS_THDMIIIHB
Use TreeLevelMasses_THDMIIIHB
Use LoopMasses_THDMIIIHB
 
Use BranchingRatios_THDMIIIHB
...
& ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,epYU,             & 
& Yu,Yd,Ye,epYD,epYE,M12,M112,M222,kont)
...
& TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,             & 
& Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,mGUT)
...
n_tot = n_tot + 2 
mass_uncertainty_Yt(n_tot:n_tot+0) = Msigma1! difference will be taken later 
n_tot = n_tot + 1 
...
& ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,Lam5,           & 
& Lam7,Lam1,Lam4,Lam3,Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,mass_uncertainty_Q)
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,TW,               & 
& ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,Lam5,           & 
& Lam7,Lam1,Lam4,Lam3,Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,gPFu,gTFu,              & 
& BRFu,gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,gPhh,gThh,BRhh,gPAh,gTAh,BRAh,gPHm,gTHm,BRHm)
...
& Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,vd,vu,Tpar,Spar,Upar,ae,amu,atau,           & 
...
& ZP,ZW,ZZ,alphaH,betaH,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,Lam2,epYU,Yu,             & 
& Yd,Ye,epYD,epYE,M12,M112,M222,mGut,kont,WriteOut,n_run)
...
& Ydinput,Yeinput,epYDinput,epYEinput,M12input,M112input,M222input,vdinput,              & 
& vuinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,      & 
& BrDmunu,ratioDmunu,BrDsmunu,ratioDsmunu,BrDstaunu,ratioDstaunu,BrBmunu,ratioBmunu,     & 
& BrBtaunu,ratioBtaunu,BrKmunu,ratioKmunu,RK,RKSM,muEgamma,tauEgamma,tauMuGamma,         & 
& CRmuEAl,CRmuETi,CRmuESr,CRmuESb,CRmuEAu,CRmuEPb,BRmuTo3e,BRtauTo3e,BRtauTo3mu,         & 
& BRtauToemumu,BRtauTomuee,BRtauToemumu2,BRtauTomuee2,BrZtoMuE,BrZtoTauE,BrZtoTauMu,     & 
...
& cplAhsigma1sigma1,cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFdFdhhL(3,3,2),cplcFdFdhhR(3,3,2),& 
...
& cplcFuFuhhR(3,3,2),cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3),cplcFuFuVGL(3,3),         & 
...
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,             & 
& cplcgWpCgAcVWm,cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcVWm,cplcgZgWmcVWm,             & 
& cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,& 
...
& cplcVWmVWmVZVZ3,cplhhcHmVWm(2,2),cplhhcVWmVWm(2),cplhhhhcVWmVWm(2,2),cplhhhhhh(2,2,2), & 
& cplhhhhsigma1(2,2),cplhhhhVZVZ(2,2),cplhhHmcHm(2,2,2),cplhhHmcVWm(2,2),cplhhsigma1sigma1(2),& 
& cplhhsigma1VZ(2),cplhhVZVZ(2),cplHmcHmcVWmVWm(2,2),cplHmcHmVP(2,2),cplHmcHmVPVP(2,2),  & 
& cplHmcHmVPVZ(2,2),cplHmcHmVZ(2,2),cplHmcHmVZVZ(2,2),cplHmcVWmVP(2),cplHmcVWmVZ(2),     & 
& cplHmsigma1cHm(2,2),cplHmsigma1cVWm(2),cplsigma1cHmVWm(2),cplsigma1sigma1cVWmVWm,      & 
& cplsigma1sigma1sigma1,cplsigma1sigma1VZVZ,cplVGVGVG
...
& Yeinput,epYDinput,epYEinput,M12input,M112input,M222input,vdinput,vuinput,              & 
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Lam7,vd,Lam5,Lam4,Lam3,Lam2,vu,ZH,Lam6,ZP,Lam1,g1,g2,               & 
...
& MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,             & 
...
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TSOddllSLL(gt1,gt2,gt3,gt4),TSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TVOddllSLL(gt1,gt2,gt3,gt4),TVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,            & 
...
& MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhcHmVWm,           & 
& cplAhHmcHm,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,& 
& cplcFdFdsigma1R,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,           & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,          & 
& cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,       & 
& cplcFuFuVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,         & 
& cplcFvFvVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,cplhhcVWmVWm,             & 
& cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,   & 
& cplHmsigma1cVWm,cplsigma1cHmVWm,TSOdulvSLL(gt1,gt2,gt3,gt4),TSOdulvSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFvFvVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,cplhhcVWmVWm,             & 
& cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,   & 
& cplHmsigma1cVWm,cplsigma1cHmVWm,TVOdulvSLL(gt1,gt2,gt3,gt4),TVOdulvSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,BOddllSLL(gt1,gt2,gt3,gt4),BOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PSOddllSLL(gt1,gt2,gt3,gt4),PSOddllSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PVOddllSLL(gt1,gt2,gt3,gt4),PVOddllSRR(gt1,gt2,gt3,gt4)& 
...
& MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVZ,             & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,       & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZR,         & 
...
& MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhsigma1,cplAhhhsigma1,             & 
& cplAhsigma1sigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,     & 
& cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFdcHmL,            & 
...
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,OAh2qSL(gt1,gt2,gt3),OAh2qSR(gt1,gt2,gt3))
...
& Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplcFdFdAhL,cplcFdFdAhR,            & 
...
& MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,       & 
...
& cplhhsigma1VZ,cplhhVZVZ,OH2qSL(gt1,gt2,gt3),OH2qSR(gt1,gt2,gt3))
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TSOddllSLLSM(gt1,gt2,gt3,gt4),TSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TVOddllSLLSM(gt1,gt2,gt3,gt4),TVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFvVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,cplhhcVWmVWm,             & 
& cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,   & 
& cplHmsigma1cVWm,cplsigma1cHmVWm,TSOdulvSLLSM(gt1,gt2,gt3,gt4),TSOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFvFvVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplhhcHmVWm,cplhhcVWmVWm,             & 
& cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,   & 
& cplHmsigma1cVWm,cplsigma1cHmVWm,TVOdulvSLLSM(gt1,gt2,gt3,gt4),TVOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,BOddllSLLSM(gt1,gt2,gt3,gt4),BOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PSOddllSLLSM(gt1,gt2,gt3,gt4),PSOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PVOddllSLLSM(gt1,gt2,gt3,gt4),PVOddllSRRSM(gt1,gt2,gt3,gt4)& 
...
& Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhAhsigma1,  & 
& cplAhcHmVWm,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,& 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,       & 
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFusigma1L,cplcFuFusigma1R,              & 
& cplhhhhsigma1,cplhhsigma1sigma1,cplhhsigma1VZ,cplHmsigma1cHm,cplHmsigma1cVWm,          & 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,OAh2qSLSM(gt1,gt2,gt3),OAh2qSRSM(gt1,gt2,gt3))
...
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplhhcHmVWm,          & 
& cplhhcVWmVWm,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhVZVZ,OH2qSLSM(gt1,gt2,gt3),OH2qSRSM(gt1,gt2,gt3))
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TSOllddSLL(gt1,gt2,gt3,gt4),TSOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TVOllddSLL(gt1,gt2,gt3,gt4),TVOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4)& 
...
& MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhAhsigma1,       & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhsigma1sigma1,cplcFeFeAhL,cplcFeFeAhR,           & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,       & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,TSO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,TVO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,TSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,TVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,BOllddSLL(gt1,gt2,gt3,gt4),BOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PSOllddSLL(gt1,gt2,gt3,gt4),PSOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PVOllddSLL(gt1,gt2,gt3,gt4),PVOllddSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4)& 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cHm,cplHmsigma1cVWm,& 
& cplsigma1cHmVWm,cplsigma1sigma1sigma1,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,BO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,PSO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,PVO4lSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,BO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,PSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplhhhhhh,cplhhhhsigma1,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplsigma1sigma1sigma1,PVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,         & 
& cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcHmVPVWm,cplcVWmVPVWm,cplHmcHmVP,          & 
& cplHmcVWmVP,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2),OA1L(gt1,gt2),OA1R(gt1,gt2))
...
& Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,      & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,               & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,OH2lSL(gt1,gt2,gt3),OH2lSR(gt1,gt2,gt3))
...
& Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,    & 
& cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcHmVWmVZ,          & 
& cplcVWmVWmVZ,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,OZ2lSL(gt1,gt2)            & 
...
Call Gminus2(1,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,cplcFeFeAhL,      & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,ae)

Call Gminus2(2,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,cplcFeFeAhL,      & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,cplcFeFeAhL,      & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFeFvHmL,cplcFeFvHmR,cplHmcHmVP,atau)


! *****  Lepton EDM ***** 

Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,           & 
& MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,        & 
...
& cplcFeFvVWmR,cplHmcHmVP,cplcVWmVPVWm,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,           & 
& MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,        & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,          & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplHmcHmVP,cplcVWmVPVWm,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,           & 
& MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,        & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,          & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplHmcHmVP,cplcVWmVPVWm,EDMtau)
...
Call DeltaRho(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,          & 
& Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,cplAhHmcVWm,         & 
...
& cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,& 
...
& cplhhHmcVWm,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmcVWmVWm,cplHmcHmVZ,cplHmcHmVZVZ,           & 
& cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cVWm,cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,dRho)

Call STUparameter(vSM,g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,MAh,MAh2,MFd,MFd2,MFe,            & 
& MFe2,MFu,MFu2,Mhh,Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplhhsigma1VZ,    & 
& cplHmsigma1cVWm,cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,cplAhhhVZ,cplAhHmcVWm,      & 
& cplAhAhcVWmVWm,cplAhAhVZVZ,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,            & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplHmcHmVP,cplHmcVWmVP,            & 
& cplcVWmVPVWm,cplHmcHmVPVP,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,             & 
...
Subroutine ScatteringEigenvalues(vd,vu,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,             & 
...
Real(dp) :: eigenvalues_matrix(36), test(2) 
...
& TWinput,ZDRinput,ZERinput,ZURinput,vinput,ZDLinput,ZELinput,ZULinput,ZHinput,          & 
& ZPinput,ZWinput,ZZinput,alphaHinput,betaHinput,vdinput,vuinput,g1input,g2input,        & 
& g3input,Lam6input,Lam5input,Lam7input,Lam1input,Lam4input,Lam3input,Lam2input,         & 
& epYUinput,Yuinput,Ydinput,Yeinput,epYDinput,epYEinput,M12input,M112input,              & 
& M222input,mass_Qerror)
...
& Msigma12input,MVWminput,MVWm2input,MVZinput,MVZ2input,TWinput,vinput,ZHinput(2,2),     & 
...
n_tot = n_tot + 2 
mass_in(n_tot:n_tot+0) = Msigma1input
n_tot = n_tot + 1 
...
& Yu,Yd,Ye,epYD,epYE,M12,M112,M222,vd,vu,gD)
...
n_tot = n_tot + 2 
mass_new(n_tot:n_tot+0) = Msigma1
n_tot = n_tot + 1 
