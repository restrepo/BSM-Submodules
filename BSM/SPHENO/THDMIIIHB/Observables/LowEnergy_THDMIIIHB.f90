...
Subroutine Gminus2(Ifermion,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,              & 
& Msigma12,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,              & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFeFvHmL,         & 
& cplcFeFvHmR,cplHmcHmVP,a_mu)

Real(dp),Intent(in)  :: MAh,MAh2,MFe(3),MFe2(3),Mhh(2),Mhh2(2),MHm(2),MHm2(2),Msigma1,Msigma12
...
& cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),         & 
& cplHmcHmVP(2,2)
...
a_mu = a_mu - 2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0.& 
      & - (1._dp)*2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F1(ratio)/0._dp 
End if 
...
Subroutine LeptonEDM(Ifermion,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHm,MHm2,Msigma1,            & 
& Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,          & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplHmcHmVP,cplcVWmVPVWm,EDM)
...
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplHmcHmVP(2,2),cplcVWmVPVWm
...
& Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,             & 
...
& cplHmcVWmVP,cplHmcVWmVZ,cplHmsigma1cVWm,cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,rho)
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ(2),cplAhHmcVWm(2),cplcFdFdVZL(3,3),              & 
...
& cplhhhhcVWmVWm(2,2),cplhhhhVZVZ(2,2),cplhhHmcVWm(2,2),cplhhsigma1VZ(2),cplhhVZVZ(2),   & 
& cplHmcHmcVWmVWm(2,2),cplHmcHmVZ(2,2),cplHmcHmVZVZ(2,2),cplHmcVWmVP(2),cplHmcVWmVZ(2),  & 
& cplHmsigma1cVWm(2),cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ
...
Call Pi1LoopVZ(0._dp,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Msigma1,            & 
...
& MVZ2,cplhhsigma1VZ,cplHmsigma1cVWm,cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,         & 
& cplAhhhVZ,cplAhHmcVWm,cplAhAhcVWmVWm,cplAhAhVZVZ,cplcFdFdVPL,cplcFdFdVPR,              & 
...
& cplcVWmVPVPVWm3,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,           & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFvFecVWmL,             & 
...
Complex(dp),Intent(in)  :: cplhhsigma1VZ(2),cplHmsigma1cVWm(2),cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,       & 
...
& cplcgWmgWmVZ,cplcgWpCgWpCVZ,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,            & 
& cplcVWmVWmVZ,cplAhAhVZVZ,cplhhhhVZVZ,cplHmcHmVZVZ,cplsigma1sigma1VZVZ,cplcVWmVWmVZVZ1, & 
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,kont,PiZZ)

Call Pi1LoopVZ(MVZ2,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Msigma1,             & 
& Msigma12,MVZ,MVZ2,MHm,MHm2,MVWm,MVWm2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVZL,cplcFvFvVZR,               & 
& cplcgWmgWmVZ,cplcgWpCgWpCVZ,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,            & 
& cplcVWmVWmVZ,cplAhAhVZVZ,cplhhhhVZVZ,cplHmcHmVZVZ,cplsigma1sigma1VZVZ,cplcVWmVWmVZVZ1, & 
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,kont,PiZZ_mz2)
...
End Function C1C2 
End Module LowEnergy_THDMIIIHB 
