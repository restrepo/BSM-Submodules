...
Real(dp),Intent(in) :: MFd(3),MVZ,MAh,Mhh(2)
...
coup(2) = Conjg(cplcFdFdAhL(iIN,gt1)) 
coup(1) = Conjg(cplcFdFdAhR(iIN,gt1)) 
...
coup(2) = Conjg(cplcFdFdAhL(iIN,gt3)) 
coup(1) = Conjg(cplcFdFdAhR(iIN,gt3)) 
coup(4) = Conjg(cplcFdFdAhL(gt2,gt1)) 
coup(3) = Conjg(cplcFdFdAhR(gt2,gt1))
Call IntegrateScalarSS(Boson2,mass,coup,deltaM,epsI,IntegralSs,NSs,resR, check) 
If (gt1.Eq.gt3) Then 
resR=resR/2._dp 
End If
...
coup2(1) = cplcFdFdAhL(iIN,gt3) 
coup2(2) = cplcFdFdAhR(iIN,gt3) 
coup2(3) = Conjg(cplcFdFdAhL(iIN,gt1)) 
coup2(4) = Conjg(cplcFdFdAhR(iIN,gt1))  
coup2(5) = cplcFdFdAhL(gt2,gt1) 
coup2(6) = cplcFdFdAhR(gt2,gt1) 
...
coup2(1) = cplcFdFdVZL(iIN,gt3) 
coup2(2) = cplcFdFdVZR(iIN,gt3) 
coup2(3) = Conjg(cplcFdFdAhL(iIN,gt3)) 
coup2(4) = Conjg(cplcFdFdAhR(iIN,gt3))  
coup2(5) = cplcFdFdVZL(gt2,gt1) 
coup2(6) = cplcFdFdVZR(gt2,gt1) 
coup2(7) = Conjg(cplcFdFdAhL(gt2,gt1)) 
coup2(8) = Conjg(cplcFdFdAhR(gt2,gt1)) 
Call IntegrateGaugeSscalarS(Boson4, mass, coup2, deltaM, epsI,IntegralVSss,NVSss, resC, check) 
If (resC.ne.resC) resC = 0._dp
resC = 2._dp*resC 
resC= 3*resC ! color factor 
...
coup2(1) = cplcFdFdAhL(iIN,gt1) 
coup2(2) = cplcFdFdAhR(iIN,gt1) 
coup2(3) = Conjg(cplcFdFdhhL(iIN,gt1,i2)) 
coup2(4) = Conjg(cplcFdFdhhR(iIN,gt1,i2))  
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MVZ,MAh,Mhh(2)
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MVZ,MVWm,MHm(2),MAh,Mhh(2)
...
End Module Fd3Decays_THDMIIIHB 
