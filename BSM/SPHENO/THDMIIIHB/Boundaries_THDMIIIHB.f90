...
& Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,               & 
& ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,vd,vu,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,              & 
& Lam3,Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,delta0,gMZ,kont)
...
Complex(dp) :: cplhhsigma1VZ(2),cplHmsigma1cVWm(2),cplsigma1sigma1cVWmVWm,cplsigma1sigma1VZVZ,       & 
...
Complex(dp) :: cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),cplcUFdFdhhL(3,3,2),cplcUFdFdhhR(3,3,2),          & 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,MVWm,MHm,MFd,MFu,MFe) 
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MFe,Mhh,MHm,Msigma1,MVWm,epYE,g2,ZER,              & 
& vd,vu,ZEL,Ye,ZH,ZP,delta)
...
Call Sigma1LoopFeMZ(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,Msigma1,Msigma12,MVZ,               & 
& MVZ2,MHm,MHm2,MVWm,MVWm2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,          & 
& cplcUFeFesigma1L,cplcUFeFesigma1R,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,              & 
& cplcUFeFeVZR,cplcUFeFvHmL,cplcUFeFvHmR,cplcUFeFvVWmL,cplcUFeFvVWmR,sigR_l,             & 
& sigL_l,sigSL_l,sigSR_l)

Call Sigma1LoopFdMZ(p2,MFd,MFd2,MAh,MAh2,Mhh,Mhh2,Msigma1,Msigma12,MVZ,               & 
& MVZ2,MHm,MHm2,MFu,MFu2,MVWm,MVWm2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,              & 
...
& cplcUFdFuVWmL,cplcUFdFuVWmR,sigR_d,sigL_d,sigSL_d,sigSR_d)
...
& Mhh2,MHm,MHm2,Msigma1,Msigma12,MVWm,MVWm2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,v,ZDL,               & 
& ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,g1,g2,g3,Lam6,Lam5,Lam7,Lam1,Lam4,Lam3,               & 
& Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,mGut,kont,WriteComment,niter)
...
Complex(dp) :: cplAhAhUhh(2),cplAhUhhhh(2,2),cplAhUhhsigma1(2),cplAhUhhVZ(2),cplcFdFdUhhL(3,3,2),    & 
...
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+0) = Msigma1
n_tot = n_tot + 1 
...
& epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,delta0,gB,kont)
...
End Module Boundaries_THDMIIIHB 
