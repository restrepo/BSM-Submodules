...
& gP1LAh(1,55),gT1LAh,BR1LAh(1,55),gP1LHm(2,28),gT1LHm(2),BR1LHm(2,28)

Real(dp) :: ratioFd(2,3),ratioFe(2,3),ratioFu(2,3),ratioHm(2,2),ratioVWm(2)

Complex(dp) :: ratioGG(2),ratioPP(2)

Real(dp) :: ratioPFd(1,3),ratioPFe(1,3),ratioPFu(1,3),ratioPHm(1,2),ratioPVWm
...
Logical, save :: InputValueforepYE =.False. 
...
Real(dp) :: BRHAA(2,1)= 0._dp 
 Real(dp) :: BRAHH(1,2)=0._dp
Real(dp) :: BRAAA(1,1)  = 0._dp 
 Real(dp) :: BRHHHijk(2,2,2)=0._dp
Real(dp) :: BRHHAijk(2,2,1)=0._dp
Real(dp) :: BRHAAijk(2,1,1)  = 0._dp 
 Real(dp) :: BRAHHijk(1,2,2)=0._dp
Real(dp) :: BRAHAijk(1,2,1)=0._dp
Real(dp) ::  BRAAAijk(1,1,1)  = 0._dp 
 Real(dp) :: BRHHZ(2,2)=0._dp
Real(dp) :: BRHAZ(2,1)  = 0._dp 
 Real(dp) :: BRAHZ(1,2) =0._dp
Real(dp) :: BRAAZ(1,1)  = 0._dp 
 Real(dp) :: BRAHpW(2,2)=0._dp
Real(dp) :: BRHhpW(1,2)  = 0._dp 
 Real(dp) :: BRinvH(2), BRinvA(1)  = 0._dp 
Real(dp) :: rHB_P_VP(1),rHB_S_VP(2)
Real(dp) :: rHB_P_VZ(1),rHB_S_VZ(2)
Real(dp) :: rHB_P_VG(1),rHB_S_VG(2)
Real(dp) :: rHB_P_VWm(1),rHB_S_VWm(2)
Real(dp) :: rHB_P_P_Fd(1,3),rHB_P_S_Fd(1,3),rHB_S_S_Fd(2,3),rHB_S_P_Fd(2,3)
Real(dp) :: rHB_P_P_Fu(1,3),rHB_P_S_Fu(1,3),rHB_S_S_Fu(2,3),rHB_S_P_Fu(2,3)
Real(dp) :: rHB_P_P_Fe(1,3),rHB_P_S_Fe(1,3),rHB_S_S_Fe(2,3),rHB_S_P_Fe(2,3)
Real(dp) :: rHB_P_P_Fv(1),rHB_P_S_Fv(1),rHB_S_S_Fv(2),rHB_S_P_Fv(2)
Complex(dp) :: CPL_A_H_Z(2)  =0._dp 
...
End Module Model_Data_THDMIIIHB