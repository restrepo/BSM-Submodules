...
Module OneLoopDecay_Fd_THDMIIIHB
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_THDMIIIHB_FdToFdAh(cplcFdFdAhL,cplcFdFdAhR,MAh,             & 
& MFd,MAh2,MFd2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFdAh


Subroutine Gamma_Real_THDMIIIHB_FdToFdAh(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,       & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFdAh


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdAh(cplcFdFdAhL,cplcFdFdAhR,ctcplcFdFdAhL,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdAh


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdAh


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhAh,cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,     & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,            & 
& cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdAh


Subroutine Amplitude_Tree_THDMIIIHB_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,             & 
& Mhh,MFd2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFdhh


Subroutine Gamma_Real_THDMIIIHB_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFdhh


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdhh


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdhh


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,       & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdhh


Subroutine Amplitude_Tree_THDMIIIHB_FdToFdsigma1(cplcFdFdsigma1L,cplcFdFdsigma1R,     & 
& MFd,Msigma1,MFd2,Msigma12,Amp)

Implicit None

Real(dp), Intent(in) :: MFd(3),Msigma1,MFd2(3),Msigma12

Complex(dp), Intent(in) :: cplcFdFdsigma1L(3,3),cplcFdFdsigma1R(3,3)
...
Mex3 = Msigma1 
! Tree-Level Vertex 
coupT1L = cplcFdFdsigma1L(gt1,gt2)
coupT1R = cplcFdFdsigma1R(gt1,gt2)
Call TreeAmp_FtoFS(Mex1,Mex2,Mex3,coupT1L,coupT1R,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFdsigma1


Subroutine Gamma_Real_THDMIIIHB_FdToFdsigma1(MLambda,em,gs,cplcFdFdsigma1L,           & 
& cplcFdFdsigma1R,MFd,Msigma1,GammarealPhoton,GammarealGluon)

Implicit None

Complex(dp), Intent(in) :: cplcFdFdsigma1L(3,3),cplcFdFdsigma1R(3,3)

Real(dp), Intent(in) :: MFd(3),Msigma1
...
Do i1=1,3
  Do i2=1,3
CoupL = cplcFdFdsigma1L(i1,i2)
CoupR = cplcFdFdsigma1R(i1,i2)
Mex1 = MFd(i1)
Mex2 = MFd(i2)
Mex3 = Msigma1
If (Mex1.gt.(Mex2+Mex3)) Then 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFdsigma1


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdsigma1(cplcFdFdsigma1L,cplcFdFdsigma1R,     & 
& ctcplcFdFdsigma1L,ctcplcFdFdsigma1R,MFd,MFd2,Msigma1,Msigma12,ZfDL,ZfDR,               & 
& Zfsigma1,Amp)

Implicit None

Real(dp), Intent(in) :: MFd(3),MFd2(3),Msigma1,Msigma12

Complex(dp), Intent(in) :: cplcFdFdsigma1L(3,3),cplcFdFdsigma1R(3,3)

Complex(dp), Intent(in) :: ctcplcFdFdsigma1L(3,3),ctcplcFdFdsigma1R(3,3)

Complex(dp), Intent(in) :: ZfDL(3,3),ZfDR(3,3),Zfsigma1
...
! Coupling counter term 
!----------------------------- 
ZcoupT1L = ctcplcFdFdsigma1L(gt1,gt2) 
ZcoupT1R = ctcplcFdFdsigma1R(gt1,gt2) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfDR(i1,gt1)*cplcFdFdsigma1L(i1,gt2)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfDL(i1,gt1))*cplcFdFdsigma1R(i1,gt2)
End Do


! External Field 2 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfDL(i1,gt2)*cplcFdFdsigma1L(gt1,i1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfDR(i1,gt2))*cplcFdFdsigma1R(gt1,i1)
End Do


! External Field 3 
ZcoupT1L = ZcoupT1L + 0.5_dp*Zfsigma1*cplcFdFdsigma1L(gt1,gt2)
ZcoupT1R = ZcoupT1R + 0.5_dp*Zfsigma1*cplcFdFdsigma1R(gt1,gt2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdsigma1


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdsigma1(MAh,MFd,MFu,Mhh,MHm,               & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplAhhhsigma1,cplAhsigma1sigma1,            & 
...
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,   & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplhhhhsigma1,cplhhsigma1sigma1,cplhhsigma1VZ,               & 
...
Complex(dp), Intent(in) :: cplAhAhsigma1,cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplAhhhsigma1(2),cplAhsigma1sigma1,   & 
...
& cplcFuFdcVWmR(3,3),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFusigma1L(3,3),         & 
& cplcFuFusigma1R(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplhhhhsigma1(2,2),           & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdsigma1


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdsigma1(MAh,MFd,MFu,Mhh,MHm,            & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplAhhhsigma1,cplAhsigma1sigma1,            & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdsigma1


Subroutine Amplitude_Tree_THDMIIIHB_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,             & 
& MVZ,MFd2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFdVZ


Subroutine Gamma_Real_THDMIIIHB_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,       & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFdVZ


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,     & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVZ


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVZ


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,             & 
& cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVZ


Subroutine Amplitude_Tree_THDMIIIHB_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,MFd,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFuHm


Subroutine Gamma_Real_THDMIIIHB_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFuHm


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,ctcplcFdFuHmL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFuHm


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFuHm(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplAhHmcVWm(2),cplcFdFdhhL(3,3,2),cplcFdFdhhR(3,3,2),cplcFdFdsigma1L(3,3),             & 
& cplcFdFdsigma1R(3,3),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVPL(3,3),               & 
& cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),& 
...
& cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhHmcHm(2,2,2),cplhhHmcVWm(2,2),& 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFuHm


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFuHm(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhHmcVWm,cplcFdFdhhL,    & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFuHm


Subroutine Amplitude_Tree_THDMIIIHB_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FdToFuVWm


Subroutine Gamma_Real_THDMIIIHB_FdToFuVWm(MLambda,em,gs,cplcFdFuVWmL,cplcFdFuVWmR,    & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FdToFuVWm


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFuVWm


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFuVWm(MAh,MFd,MFu,Mhh,MHm,Msigma1,          & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplhhcVWmVWm,cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplAhcHmVWm(2),   & 
& cplcFdFdhhL(3,3,2),cplcFdFdhhR(3,3,2),cplcFdFdsigma1L(3,3),cplcFdFdsigma1R(3,3),       & 
& cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),  & 
& cplcFdFdVZR(3,3),cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),cplcFdFuHmL(3,3,2),             & 
& cplcFdFuHmR(3,3,2),cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3),cplcFuFuVGL(3,3),         & 
& cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),& 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhcHmVWm(2,2),cplhhcVWmVWm(2),cplsigma1cHmVWm(2), & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFuVWm


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFuVWm(MAh,MFd,MFu,Mhh,MHm,               & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhcHmVWm,cplcFdFdhhL,          & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,               & 
& cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,       & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhcHmVWm,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFuVWm


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,   & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVG


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVG(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVG


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVG(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,       & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVG


Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,     & 
& cplcFdFdVZR,ctcplcFdFdVPL,ctcplcFdFdVPR,ctcplcFdFdVZL,ctcplcFdFdVZR,MFd,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FdToFdVP


Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVP(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,       & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FdToFdVP


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVP(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,       & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FdToFdVP



End Module OneLoopDecay_Fd_THDMIIIHB
