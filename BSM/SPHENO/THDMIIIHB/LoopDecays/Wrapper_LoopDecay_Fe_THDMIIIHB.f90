...
Module Wrapper_OneLoopDecay_Fe_THDMIIIHB
Use Model_Data_THDMIIIHB 
Use Kinematics 
Use OneLoopDecay_Fe_THDMIIIHB 
Use Control 
Use Settings 
...
& cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplcFeFeAhL,          & 
...
& cplHmsigma1cVWm,cplsigma1cHmVWm,cplsigma1sigma1sigma1,ctcplcFeFeAhL,ctcplcFeFeAhR,     & 
& ctcplcFeFehhL,ctcplcFeFehhR,ctcplcFeFesigma1L,ctcplcFeFesigma1R,ctcplcFeFeVPL,         & 
...
& ZcplcFeFesigma1L,ZcplcFeFesigma1R,ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,              & 
...
& cplAhhhVZ(2),cplAhHmcHm(2,2),cplAhHmcVWm(2),cplAhsigma1sigma1,cplcFeFeAhL(3,3),        & 
...
& cplcFeFvVWmR(3,3),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),cplcFvFecVWmL(3,3),          & 
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcHmVPVWm(2),cplcHmVWmVZ(2),    & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm(2,2),cplhhcVWmVWm(2),cplhhhhhh(2,2,2),           & 
...
& cplsigma1sigma1sigma1,ctcplcFeFeAhL(3,3),ctcplcFeFeAhR(3,3),ctcplcFeFehhL(3,3,2),      & 
& ctcplcFeFehhR(3,3,2),ctcplcFeFesigma1L(3,3),ctcplcFeFesigma1R(3,3),ctcplcFeFeVPL(3,3), & 
...
& GZcplcFeFvHmR(3,3,2),GZcplcHmVPVWm(2),GZcplHmcVWmVP(2),ZcplcFeFeAhL(3,3),              & 
& ZcplcFeFeAhR(3,3),ZcplcFeFehhL(3,3,2),ZcplcFeFehhR(3,3,2),ZcplcFeFesigma1L(3,3),       & 
& ZcplcFeFesigma1R(3,3),ZcplcFeFeVPL(3,3),ZcplcFeFeVPR(3,3),ZcplcFeFeVZL(3,3),           & 
& ZcplcFeFeVZR(3,3),ZcplcFeFvHmL(3,3,2),ZcplcFeFvHmR(3,3,2),ZcplcFeFvVWmL(3,3),          & 
& ZcplcFeFvVWmR(3,3),ZcplcFvFecHmL(3,3,2),ZcplcFvFecHmR(3,3,2),ZcplcFvFecVWmL(3,3),      & 
& ZcplcFvFecVWmR(3,3),ZcplcHmVPVWm(2),ZcplcVWmVPVWm,ZcplHmcHmVP(2,2),ZcplHmcVWmVP(2)
...
Real(dp) :: MRPFeToFeAh(3,3),MRGFeToFeAh(3,3), MRPZFeToFeAh(3,3),MRGZFeToFeAh(3,3) 
Real(dp) :: MVPFeToFeAh(3,3) 
Real(dp) :: RMsqTreeFeToFeAh(3,3),RMsqWaveFeToFeAh(3,3),RMsqVertexFeToFeAh(3,3) 
Complex(dp) :: AmpTreeFeToFeAh(2,3,3),AmpWaveFeToFeAh(2,3,3)=(0._dp,0._dp),AmpVertexFeToFeAh(2,3,3)& 
 & ,AmpVertexIRosFeToFeAh(2,3,3),AmpVertexIRdrFeToFeAh(2,3,3), AmpSumFeToFeAh(2,3,3), AmpSum2FeToFeAh(2,3,3) 
Complex(dp) :: AmpTreeZFeToFeAh(2,3,3),AmpWaveZFeToFeAh(2,3,3),AmpVertexZFeToFeAh(2,3,3) 
Real(dp) :: AmpSqFeToFeAh(3,3),  AmpSqTreeFeToFeAh(3,3) 
...
Call Amplitude_Tree_THDMIIIHB_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,MAh,MFe,               & 
& MAh2,MFe2,AmpTreeFeToFeAh)

  Else 
Call Amplitude_Tree_THDMIIIHB_FeToFeAh(ZcplcFeFeAhL,ZcplcFeFeAhR,MAh,MFe,             & 
& MAh2,MFe2,AmpTreeFeToFeAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFeAh(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,             & 
& MAhOS,MFeOS,MRPFeToFeAh,MRGFeToFeAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFeAh(MLambda,em,gs,ZcplcFeFeAhL,ZcplcFeFeAhR,           & 
& MAhOS,MFeOS,MRPFeToFeAh,MRGFeToFeAh)
...
Call Amplitude_WAVE_THDMIIIHB_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,ctcplcFeFeAhL,         & 
& ctcplcFeFeAhR,MAh,MAh2,MFe,MFe2,ZfAh,ZfEL,ZfER,AmpWaveFeToFeAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFeAh(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFeAh(MAh,MFe,Mhh,MHm,Msigma1,MVP,              & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRdrFeToFeAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFeAh(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,        & 
...
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRosFeToFeAh)
...
i4 = isave 
  Do gt2=1,3
If (((OSkinematics).and.(MFeOS(gt1).gt.(MFeOS(gt2)+MAhOS))).or.((.not.OSkinematics).and.(MFe(gt1).gt.(MFe(gt2)+MAh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2FeToFeAh = AmpTreeFeToFeAh
If (OSkinematics) Then 
  Call SquareAmp_FtoFS(MFeOS(gt1),MFeOS(gt2),MAhOS,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
Else  
  Call SquareAmp_FtoFS(MFe(gt1),MFe(gt2),MAh,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqFeToFeAh(gt1, gt2) 
...
Else  
  Call SquareAmp_FtoFS(MFe(gt1),MFe(gt2),MAh,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqFeToFeAh(gt1, gt2) 
...
Else  
  Call SquareAmp_FtoFS(MFe(gt1),MFe(gt2),MAh,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqFeToFeAh(gt1, gt2) 
  AmpSum2FeToFeAh = AmpTreeFeToFeAh + 2._dp*AmpWaveFeToFeAh + 2._dp*AmpVertexFeToFeAh
If (OSkinematics) Then 
  Call SquareAmp_FtoFS(MFeOS(gt1),MFeOS(gt2),MAhOS,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
Else  
  Call SquareAmp_FtoFS(MFe(gt1),MFe(gt2),MAh,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqFeToFeAh(gt1, gt2) 
 End if 
If (OSkinematics) Then 
  AmpSum2FeToFeAh = AmpTreeFeToFeAh
  Call SquareAmp_FtoFS(MFeOS(gt1),MFeOS(gt2),MAhOS,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
  AmpSqTreeFeToFeAh(gt1, gt2) = AmpSqFeToFeAh(gt1, gt2)  
  AmpSum2FeToFeAh = + 2._dp*AmpWaveFeToFeAh + 2._dp*AmpVertexFeToFeAh
  Call SquareAmp_FtoFS(MFeOS(gt1),MFeOS(gt2),MAhOS,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
  AmpSqFeToFeAh(gt1, gt2) = AmpSqFeToFeAh(gt1, gt2) + AmpSqTreeFeToFeAh(gt1, gt2)  
Else  
  AmpSum2FeToFeAh = AmpTreeFeToFeAh
  Call SquareAmp_FtoFS(MFe(gt1),MFe(gt2),MAh,AmpSumFeToFeAh(:,gt1, gt2),AmpSum2FeToFeAh(:,gt1, gt2),AmpSqFeToFeAh(gt1, gt2)) 
  AmpSqTreeFeToFeAh(gt1, gt2) = AmpSqFeToFeAh(gt1, gt2)  
...
End if  
Else  
  AmpSqFeToFeAh(gt1, gt2) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFeToFeAh(gt1, gt2).le.0._dp) Then 
  gP1LFe(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1LFe(gt1,i4) = 1._dp*GammaTPS(MFeOS(gt1),MFeOS(gt2),MAhOS,helfactor*AmpSqFeToFeAh(gt1, gt2))
Else 
  gP1LFe(gt1,i4) = 1._dp*GammaTPS(MFe(gt1),MFe(gt2),MAh,helfactor*AmpSqFeToFeAh(gt1, gt2))
End if 
If ((Abs(MRPFeToFeAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGFeToFeAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
...
If ((Abs(MRPFeToFeAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGFeToFeAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPFeToFeAh(gt1, gt2) + MRGFeToFeAh(gt1, gt2)) 
  gP1LFe(gt1,i4) = gP1LFe(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPFeToFeAh(gt1, gt2) + MRGFeToFeAh(gt1, gt2))
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FeToFehh(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,               & 
& MFe2,Mhh2,AmpTreeFeToFehh)

  Else 
Call Amplitude_Tree_THDMIIIHB_FeToFehh(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,             & 
& MFe2,Mhh2,AmpTreeFeToFehh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,             & 
& MFeOS,MhhOS,MRPFeToFehh,MRGFeToFehh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFehh(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,           & 
& MFeOS,MhhOS,MRPFeToFehh,MRGFeToFehh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FeToFehh(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,         & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWaveFeToFehh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFehh(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,            & 
...
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexFeToFehh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFehh(MAh,MFe,Mhh,MHm,Msigma1,MVP,              & 
...
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFeToFehh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFehh(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,        & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
...
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFeToFehh)
...
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFeToFehh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,MFe,MVZ,               & 
& MFe2,MVZ2,AmpTreeFeToFeVZ)

  Else 
Call Amplitude_Tree_THDMIIIHB_FeToFeVZ(ZcplcFeFeVZL,ZcplcFeFeVZR,MFe,MVZ,             & 
& MFe2,MVZ2,AmpTreeFeToFeVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,             & 
& MFeOS,MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFeVZ(MLambda,em,gs,ZcplcFeFeVZL,ZcplcFeFeVZR,           & 
& MFeOS,MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFeVZ(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,            & 
...
& cplcFvFvVZR,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,   & 
& AmpVertexFeToFeVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFeVZ(MAh,MFe,Mhh,MHm,Msigma1,MVP,              & 
...
& AmpVertexIRdrFeToFeVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFeVZ(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,        & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,             & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,ZcplcFeFeVZL,ZcplcFeFeVZR,cplcFvFecHmL,        & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmVZ,               & 
& cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFeToFeVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,MFe,MHm,               & 
& MFe2,MHm2,AmpTreeFeToFvHm)

  Else 
Call Amplitude_Tree_THDMIIIHB_FeToFvHm(ZcplcFeFvHmL,ZcplcFeFvHmR,MFe,MHm,             & 
& MFe2,MHm2,AmpTreeFeToFvHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFvHm(MLambda,em,gs,cplcFeFvHmL,cplcFeFvHmR,             & 
& MFeOS,MHmOS,MRPFeToFvHm,MRGFeToFvHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFvHm(MLambda,em,gs,ZcplcFeFvHmL,ZcplcFeFvHmR,           & 
& MFeOS,MHmOS,MRPFeToFvHm,MRGFeToFvHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,ctcplcFeFvHmL,         & 
& ctcplcFeFvHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveFeToFvHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFvHm(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,            & 
& MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFvHm(MAh,MFe,Mhh,MHm,Msigma1,MVP,              & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhHmcVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,               & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,cplhhHmcVWm,              & 
& cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,          & 
& AmpVertexIRdrFeToFvHm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFvHm(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,        & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhHmcHm,cplAhHmcVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,& 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,ZcplcFeFvHmL,          & 
& ZcplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,             & 
...
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhHmcVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,ZcplcFeFvHmL,ZcplcFeFvHmR,             & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,cplhhHmcVWm,              & 
& cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,          & 
& AmpVertexIRosFeToFvHm)
...
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,              & 
& cplhhHmcVWm,cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,          & 
& cplHmcVWmVZ,AmpVertexIRosFeToFvHm)
...
i4 = isave 
  Do gt2=1,3
    Do gt3=2,2
If (((OSkinematics).and.(MFeOS(gt1).gt.(0.+MHmOS(gt3)))).or.((.not.OSkinematics).and.(MFe(gt1).gt.(0.+MHm(gt3))))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2, gt3 
  AmpSum2FeToFvHm = AmpTreeFeToFvHm
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFeToFvHm(gt1, gt2, gt3).le.0._dp) Then 
  gP1LFe(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,MFe,MVWm,           & 
& MFe2,MVWm2,AmpTreeFeToFvVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_FeToFvVWm(ZcplcFeFvVWmL,ZcplcFeFvVWmR,MFe,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFvVWm(MLambda,em,gs,cplcFeFvVWmL,cplcFeFvVWmR,          & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FeToFvVWm(MLambda,em,gs,ZcplcFeFvVWmL,ZcplcFeFvVWmR,        & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,ctcplcFeFvVWmL,     & 
& ctcplcFeFvVWmR,MFe,MFe2,MVWm,MVWm2,ZfEL,ZfER,ZfvL,ZfVWm,AmpWaveFeToFvVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFvVWm(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,           & 
& MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
...
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexFeToFvVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFvVWm(MAh,MFe,Mhh,MHm,Msigma1,MVP,             & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,              & 
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplsigma1cHmVWm,         & 
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFeToFvVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FeToFvVWm(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,       & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,           & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,GosZcplcFeFvHmL,       & 
& GosZcplcFeFvHmR,ZcplcFeFvVWmL,ZcplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,       & 
& cplhhcVWmVWm,cplsigma1cHmVWm,GosZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,    & 
...
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,GZcplcFeFvHmL,GZcplcFeFvHmR,ZcplcFeFvVWmL,         & 
& ZcplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplsigma1cHmVWm,        & 
& GZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFeToFvVWm)
...
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,           & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,GcplcFeFvHmL,          & 
& GcplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,            & 
& cplhhcVWmVWm,cplsigma1cHmVWm,GcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,       & 
& AmpVertexIRosFeToFvVWm)
...
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,              & 
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplsigma1cHmVWm,         & 
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFeToFvVWm)
...
i4 = isave 
  Do gt2=1,3
If (((OSkinematics).and.(MFeOS(gt1).gt.(0.+MVWmOS))).or.((.not.OSkinematics).and.(MFe(gt1).gt.(0.+MVWm)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2FeToFvVWm = AmpTreeFeToFvVWm
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFeToFvVWm(gt1, gt2).le.0._dp) Then 
  gP1LFe(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_FeToFeVP(ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,        & 
...
& MFe2OS,MVP,MVP2,ZfEL,ZfER,ZfVP,ZfVZVP,AmpWaveFeToFeVP)
 ...
 Else 
Call Amplitude_WAVE_THDMIIIHB_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_FeToFeVP(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,           & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& ZcplcFeFeAhL,ZcplcFeFeAhR,ZcplcFeFehhL,ZcplcFeFehhR,ZcplcFeFesigma1L,ZcplcFeFesigma1R, & 
& ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,ZcplcFeFeVZR,ZcplcFvFecHmL,ZcplcFvFecHmR,       & 
& ZcplcFvFecVWmL,ZcplcFvFecVWmR,ZcplcFeFvHmL,ZcplcFeFvHmR,ZcplcFeFvVWmL,ZcplcFeFvVWmR,   & 
& ZcplHmcHmVP,ZcplHmcVWmVP,ZcplcHmVPVWm,ZcplcVWmVPVWm,AmpVertexFeToFeVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FeToFeVP(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,            & 
& MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
...
& cplcHmVPVWm,cplcVWmVPVWm,AmpVertexFeToFeVP)
...
End Module Wrapper_OneLoopDecay_Fe_THDMIIIHB
