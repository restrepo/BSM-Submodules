...
Module OneLoopDecay_Fu_THDMIIIHB
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_THDMIIIHB_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,             & 
& MFu,MAh2,MFu2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFuAh


Subroutine Gamma_Real_THDMIIIHB_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,       & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFuAh


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,   & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuAh


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
...
ML2 = Msigma1 
ML3 = MAh 
coup1L = cplcFuFusigma1L(gt1,i1)
coup1R = cplcFuFusigma1R(gt1,i1)
coup2L = cplcFuFuAhL(i1,gt2)
coup2R = cplcFuFuAhR(i1,gt2)
coup3 = cplAhAhsigma1
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3)).gt.epsCoup) Then 
...
coup1L = cplcFuFuAhL(gt1,i1)
coup1R = cplcFuFuAhR(gt1,i1)
coup2L = cplcFuFusigma1L(i1,gt2)
coup2R = cplcFuFusigma1R(i1,gt2)
coup3 = cplAhAhsigma1
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_FSS(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3,AmpC) 
Else
...
! {sigma1, bar[Fu], bar[Fu]}
  Do i2=1,3
    Do i3=1,3
ML1 = Msigma1 
ML2 = MFu(i2) 
ML3 = MFu(i3) 
coup1L = cplcFuFusigma1L(gt1,i2)
coup1R = cplcFuFusigma1R(gt1,i2)
coup2L = cplcFuFusigma1L(i3,gt2)
coup2R = cplcFuFusigma1R(i3,gt2)
coup3L = cplcFuFuAhL(i2,i3)
coup3R = cplcFuFuAhR(i2,i3)
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3L)+Abs(coup3R)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_SFF(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3L,coup3R,AmpC) 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuAh


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhAh,cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,     & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,            & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuAh


Subroutine Amplitude_Tree_THDMIIIHB_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFdcHm


Subroutine Gamma_Real_THDMIIIHB_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFdcHm


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFdcHm


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,Msigma1,          & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
coup1L = cplcFuFdcHmL(gt1,i1,i2)
coup1R = cplcFuFdcHmR(gt1,i1,i2)
coup2L = cplcFdFdsigma1L(i1,gt2)
coup2R = cplcFdFdsigma1R(i1,gt2)
coup3 = cplHmsigma1cHm(i2,gt3)
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_FSS(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3,AmpC) 
Else
 AmpC = 0._dp
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFdcHm


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcHm


Subroutine Amplitude_Tree_THDMIIIHB_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,           & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFdcVWm


Subroutine Gamma_Real_THDMIIIHB_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,               & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFdcVWm


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,           & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFdcVWm


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,Msigma1,         & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplhhcVWmVWm,cplHmsigma1cVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplAhHmcVWm(2),   & 
...
& cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),cplcFuFusigma1L(3,3),         & 
& cplcFuFusigma1R(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),               & 
& cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhHmcVWm(2,2),cplhhcVWmVWm(2),   & 
& cplHmsigma1cVWm(2),cplHmcVWmVP(2),cplHmcVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,              & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,          & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,     & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcVWm,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcVWm


Subroutine Amplitude_Tree_THDMIIIHB_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,             & 
& Mhh,MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFuhh


Subroutine Gamma_Real_THDMIIIHB_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFuhh


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuhh


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuhh


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,       & 
& cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuhh


Subroutine Amplitude_Tree_THDMIIIHB_FuToFusigma1(cplcFuFusigma1L,cplcFuFusigma1R,     & 
& MFu,Msigma1,MFu2,Msigma12,Amp)

Implicit None

Real(dp), Intent(in) :: MFu(3),Msigma1,MFu2(3),Msigma12

Complex(dp), Intent(in) :: cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3)
...
Mex3 = Msigma1 
! Tree-Level Vertex 
coupT1L = cplcFuFusigma1L(gt1,gt2)
coupT1R = cplcFuFusigma1R(gt1,gt2)
Call TreeAmp_FtoFS(Mex1,Mex2,Mex3,coupT1L,coupT1R,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFusigma1


Subroutine Gamma_Real_THDMIIIHB_FuToFusigma1(MLambda,em,gs,cplcFuFusigma1L,           & 
& cplcFuFusigma1R,MFu,Msigma1,GammarealPhoton,GammarealGluon)

Implicit None

Complex(dp), Intent(in) :: cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3)

Real(dp), Intent(in) :: MFu(3),Msigma1
...
Do i1=1,3
  Do i2=1,3
CoupL = cplcFuFusigma1L(i1,i2)
CoupR = cplcFuFusigma1R(i1,i2)
Mex1 = MFu(i1)
Mex2 = MFu(i2)
Mex3 = Msigma1
If (Mex1.gt.(Mex2+Mex3)) Then 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFusigma1


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFusigma1(cplcFuFusigma1L,cplcFuFusigma1R,     & 
& ctcplcFuFusigma1L,ctcplcFuFusigma1R,MFu,MFu2,Msigma1,Msigma12,Zfsigma1,ZfUL,ZfUR,Amp)

Implicit None

Real(dp), Intent(in) :: MFu(3),MFu2(3),Msigma1,Msigma12

Complex(dp), Intent(in) :: cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3)

Complex(dp), Intent(in) :: ctcplcFuFusigma1L(3,3),ctcplcFuFusigma1R(3,3)

Complex(dp), Intent(in) :: Zfsigma1,ZfUL(3,3),ZfUR(3,3)
...
! Coupling counter term 
!----------------------------- 
ZcoupT1L = ctcplcFuFusigma1L(gt1,gt2) 
ZcoupT1R = ctcplcFuFusigma1R(gt1,gt2) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfUR(i1,gt1)*cplcFuFusigma1L(i1,gt2)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfUL(i1,gt1))*cplcFuFusigma1R(i1,gt2)
End Do


! External Field 2 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfUL(i1,gt2)*cplcFuFusigma1L(gt1,i1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfUR(i1,gt2))*cplcFuFusigma1R(gt1,i1)
End Do


! External Field 3 
ZcoupT1L = ZcoupT1L + 0.5_dp*Zfsigma1*cplcFuFusigma1L(gt1,gt2)
ZcoupT1R = ZcoupT1R + 0.5_dp*Zfsigma1*cplcFuFusigma1R(gt1,gt2)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFusigma1


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFusigma1(MAh,MFd,MFu,Mhh,MHm,               & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplAhAhsigma1,cplcFuFuAhL,cplcFuFuAhR,cplAhhhsigma1,cplAhsigma1sigma1,            & 
& cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,               & 
...
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhsigma1,cplhhsigma1sigma1,cplhhsigma1VZ,    & 
...
Complex(dp), Intent(in) :: cplAhAhsigma1,cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplAhhhsigma1(2),cplAhsigma1sigma1,   & 
& cplcFdFdsigma1L(3,3),cplcFdFdsigma1R(3,3),cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),     & 
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,2),cplcFuFuhhR(3,3,2),           & 
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFusigma1L(3,3),cplcFuFusigma1R(3,3),       & 
& cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3), & 
& cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplhhhhsigma1(2,2),cplhhsigma1sigma1(2),& 
...
coup2L = cplcFuFuAhL(i3,gt2)
coup2R = cplcFuFuAhR(i3,gt2)
coup3L = cplcFuFusigma1L(i2,i3)
coup3R = cplcFuFusigma1R(i2,i3)
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3L)+Abs(coup3R)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_SFF(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3L,coup3R,AmpC) 
Else
 AmpC = 0._dp
...
coup2L = cplcFdFuHmL(i3,gt2,i1)
coup2R = cplcFdFuHmR(i3,gt2,i1)
coup3L = cplcFdFdsigma1L(i2,i3)
coup3R = cplcFdFdsigma1R(i2,i3)
If ((Abs(coup1L)+Abs(coup1R))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3L)+Abs(coup3R)).gt.epsCoup) Then 
Call Amp_VERTEX_FtoFS_Topology1_SFF(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1L,coup1R,coup2L,coup2R,coup3L,coup3R,AmpC) 
Else
 AmpC = 0._dp
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFusigma1


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFusigma1(MAh,MFd,MFu,Mhh,MHm,            & 
& Msigma1,MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,            & 
& MVZ2,cplAhAhsigma1,cplcFuFuAhL,cplcFuFuAhR,cplAhhhsigma1,cplAhsigma1sigma1,            & 
& cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,               & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFusigma1


Subroutine Amplitude_Tree_THDMIIIHB_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,             & 
& MVZ,MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMIIIHB_FuToFuVZ


Subroutine Gamma_Real_THDMIIIHB_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,       & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMIIIHB_FuToFuVZ


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,     & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVZ


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplAhhhVZ(2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),     & 
...
& cplcFuFuVZR(3,3),cplhhsigma1VZ(2),cplhhVZVZ(2),cplHmcHmVZ(2,2),cplHmcVWmVZ(2),         & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,   & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVZ


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,   & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVG


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplVGVGVG,Amp)
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFuFdcHmL(3,3,2),& 
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,2),          & 
& cplcFuFuhhR(3,3,2),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFusigma1L(3,3),         & 
& cplcFuFusigma1R(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),               & 
& cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplVGVGVG
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVG


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVG


Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,     & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMIIIHB_FuToFuVP


Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,Msigma1,           & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplHmcHmVP,cplHmcVWmVP,              & 
...
Complex(dp), Intent(in) :: cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFuFdcHmL(3,3,2),& 
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuhhL(3,3,2),          & 
& cplcFuFuhhR(3,3,2),cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFuFusigma1L(3,3),         & 
& cplcFuFusigma1R(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),cplcFuFuVPL(3,3),               & 
& cplcFuFuVPR(3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),& 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMIIIHB_FuToFuVP


Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,Msigma1,        & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVP



End Module OneLoopDecay_Fu_THDMIIIHB
