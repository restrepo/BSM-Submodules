...
Module Wrapper_OneLoopDecay_hh_THDMIIIHB
Use Model_Data_THDMIIIHB 
Use Kinematics 
Use OneLoopDecay_hh_THDMIIIHB 
Use Control 
Use Settings 
...
& TW,ZDR,ZER,ZUR,v,ZDL,ZEL,ZUL,ZH,ZP,ZW,ZZ,alphaH,betaH,g1,g2,g3,Lam6,Lam5,              & 
& Lam7,Lam1,Lam4,Lam3,Lam2,epYU,Yu,Yd,Ye,epYD,epYE,M12,M112,M222,vd,vu,dg1,              & 
& dg2,dg3,dM12,depYU,dYu,dYd,dYe,depYD,depYE,dLam6,dLam5,dLam7,dM112,dM222,              & 
...
& ZfUL,ZfUR,ZfEL,ZfER,ZfVPVZ,ZfVZVP,cplAhAhAh,cplAhAhAhAh1,cplAhAhAhhh1,cplAhAhAhsigma11,& 
...
Real(dp),Intent(in) :: dg1,dg2,dg3,dvd,dvu,dZH(2,2),dZP(2,2),dSinTW,dCosTW,dTanTW
...
& cplcgWmgAHm(2),cplcgWmgAVWm,cplcgWmgWmAh,cplcgWmgWmhh(2),cplcgWmgWmsigma1,             & 
& cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZHm(2),cplcgWmgZVWm,cplcgWpCgAcVWm,cplcgWpCgWpCAh,   & 
& cplcgWpCgWpChh(2),cplcgWpCgWpCsigma1,cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcHm(2),   & 
& cplcgWpCgZcVWm,cplcgZgAhh(2),cplcgZgWmcHm(2),cplcgZgWmcVWm,cplcgZgWpCHm(2),            & 
& cplcgZgWpCVWm,cplcgZgZhh(2),cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmcVWmVWmVWm1Q,         & 
& cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,             & 
& cplcVWmVPVPVWm3Q,cplcVWmVPVWm,cplcVWmVPVWmVZ1Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ3Q,      & 
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplhhcHmVPVWm1(2,2),   & 
& cplhhcHmVWm(2,2),cplhhcHmVWmVZ1(2,2),cplhhcVWmVWm(2),cplhhhhcVWmVWm1(2,2),             & 
& cplhhhhhh(2,2,2),cplhhhhhhhh1(2,2,2,2),cplhhhhhhsigma11(2,2,2),cplhhhhHmcHm1(2,2,2,2), & 
& cplhhhhsigma1(2,2),cplhhhhsigma1sigma11(2,2),cplhhhhVZVZ1(2,2),cplhhHmcHm(2,2,2),      & 
& cplhhHmcVWm(2,2),cplhhHmcVWmVP1(2,2),cplhhHmcVWmVZ1(2,2),cplhhHmsigma1cHm1(2,2,2),     & 
& cplhhsigma1sigma1(2),cplhhsigma1sigma1sigma11(2),cplhhsigma1VZ(2),cplhhVZVZ(2),        & 
& cplHmcHmcVWmVWm1(2,2),cplHmcHmVP(2,2),cplHmcHmVPVP1(2,2),cplHmcHmVPVZ1(2,2),           & 
& cplHmcHmVZ(2,2),cplHmcHmVZVZ1(2,2),cplHmcVWmVP(2),cplHmcVWmVZ(2),cplHmHmcHmcHm1(2,2,2,2),& 
& cplHmsigma1cHm(2,2),cplHmsigma1cVWm(2),cplHmsigma1cVWmVP1(2),cplHmsigma1cVWmVZ1(2),    & 
& cplHmsigma1sigma1cHm1(2,2),cplsigma1cHmVPVWm1(2),cplsigma1cHmVWm(2),cplsigma1cHmVWmVZ1(2),& 
& cplsigma1sigma1cVWmVWm1,cplsigma1sigma1sigma1,cplsigma1sigma1sigma1sigma11

Complex(dp),Intent(in) :: cplsigma1sigma1VZVZ1,ctcplAhAhhh(2),ctcplAhhhhh(2,2),ctcplAhhhsigma1(2),               & 
& ctcplAhhhVZ(2),ctcplcFdFdhhL(3,3,2),ctcplcFdFdhhR(3,3,2),ctcplcFeFehhL(3,3,2),         & 
& ctcplcFeFehhR(3,3,2),ctcplcFuFuhhL(3,3,2),ctcplcFuFuhhR(3,3,2),ctcplhhcVWmVWm(2),      & 
& ctcplhhhhhh(2,2,2),ctcplhhhhsigma1(2,2),ctcplhhHmcHm(2,2,2),ctcplhhHmcVWm(2,2),        & 
& ctcplhhsigma1sigma1(2),ctcplhhsigma1VZ(2),ctcplhhVZVZ(2),GcplcHmVPVWm(2),              & 
& GcplhhcHmVWm(2,2),GcplhhHmcHm(2,2,2),GcplhhHmcVWm(2,2),GcplHmcVWmVP(2),GosZcplcHmVPVWm(2),& 
& GosZcplhhcHmVWm(2,2),GosZcplhhHmcHm(2,2,2),GosZcplhhHmcVWm(2,2),GosZcplHmcVWmVP(2),    & 
& GZcplcHmVPVWm(2),GZcplhhcHmVWm(2,2),GZcplhhHmcHm(2,2,2),GZcplhhHmcVWm(2,2),            & 
& GZcplHmcVWmVP(2),ZcplAhAhhh(2),ZcplAhhhhh(2,2),ZcplAhhhsigma1(2),ZcplAhhhVZ(2),        & 
& ZcplcFdFdhhL(3,3,2),ZcplcFdFdhhR(3,3,2),ZcplcFeFehhL(3,3,2),ZcplcFeFehhR(3,3,2),       & 
& ZcplcFuFuhhL(3,3,2),ZcplcFuFuhhR(3,3,2),ZcplhhcVWmVWm(2),Zcplhhhhhh(2,2,2),            & 
& Zcplhhhhsigma1(2,2),ZcplhhHmcHm(2,2,2),ZcplhhHmcVWm(2,2),Zcplhhsigma1sigma1(2),        & 
& Zcplhhsigma1VZ(2),ZcplhhVZVZ(2)
...
Real(dp) :: MRPhhToAhAh(2),MRGhhToAhAh(2), MRPZhhToAhAh(2),MRGZhhToAhAh(2) 
Real(dp) :: MVPhhToAhAh(2) 
Real(dp) :: RMsqTreehhToAhAh(2),RMsqWavehhToAhAh(2),RMsqVertexhhToAhAh(2) 
Complex(dp) :: AmpTreehhToAhAh(2),AmpWavehhToAhAh(2)=(0._dp,0._dp),AmpVertexhhToAhAh(2)& 
 & ,AmpVertexIRoshhToAhAh(2),AmpVertexIRdrhhToAhAh(2), AmpSumhhToAhAh(2), AmpSum2hhToAhAh(2) 
Complex(dp) :: AmpTreeZhhToAhAh(2),AmpWaveZhhToAhAh(2),AmpVertexZhhToAhAh(2) 
Real(dp) :: AmpSqhhToAhAh(2),  AmpSqTreehhToAhAh(2) 
Real(dp) :: MRPhhTohhAh(2,2),MRGhhTohhAh(2,2), MRPZhhTohhAh(2,2),MRGZhhTohhAh(2,2) 
Real(dp) :: MVPhhTohhAh(2,2) 
Real(dp) :: RMsqTreehhTohhAh(2,2),RMsqWavehhTohhAh(2,2),RMsqVertexhhTohhAh(2,2) 
Complex(dp) :: AmpTreehhTohhAh(2,2),AmpWavehhTohhAh(2,2)=(0._dp,0._dp),AmpVertexhhTohhAh(2,2)& 
 & ,AmpVertexIRoshhTohhAh(2,2),AmpVertexIRdrhhTohhAh(2,2), AmpSumhhTohhAh(2,2), AmpSum2hhTohhAh(2,2) 
Complex(dp) :: AmpTreeZhhTohhAh(2,2),AmpWaveZhhTohhAh(2,2),AmpVertexZhhTohhAh(2,2) 
Real(dp) :: AmpSqhhTohhAh(2,2),  AmpSqTreehhTohhAh(2,2) 
Real(dp) :: MRPhhToAhVZ(2),MRGhhToAhVZ(2), MRPZhhToAhVZ(2),MRGZhhToAhVZ(2) 
Real(dp) :: MVPhhToAhVZ(2) 
Real(dp) :: RMsqTreehhToAhVZ(2),RMsqWavehhToAhVZ(2),RMsqVertexhhToAhVZ(2) 
Complex(dp) :: AmpTreehhToAhVZ(2,2),AmpWavehhToAhVZ(2,2)=(0._dp,0._dp),AmpVertexhhToAhVZ(2,2)& 
 & ,AmpVertexIRoshhToAhVZ(2,2),AmpVertexIRdrhhToAhVZ(2,2), AmpSumhhToAhVZ(2,2), AmpSum2hhToAhVZ(2,2) 
Complex(dp) :: AmpTreeZhhToAhVZ(2,2),AmpWaveZhhToAhVZ(2,2),AmpVertexZhhToAhVZ(2,2) 
Real(dp) :: AmpSqhhToAhVZ(2),  AmpSqTreehhToAhVZ(2) 
...
Real(dp) :: MRPhhToAhVP(2),MRGhhToAhVP(2), MRPZhhToAhVP(2),MRGZhhToAhVP(2) 
Real(dp) :: MVPhhToAhVP(2) 
Real(dp) :: RMsqTreehhToAhVP(2),RMsqWavehhToAhVP(2),RMsqVertexhhToAhVP(2) 
Complex(dp) :: AmpTreehhToAhVP(2,2),AmpWavehhToAhVP(2,2)=(0._dp,0._dp),AmpVertexhhToAhVP(2,2)& 
 & ,AmpVertexIRoshhToAhVP(2,2),AmpVertexIRdrhhToAhVP(2,2), AmpSumhhToAhVP(2,2), AmpSum2hhToAhVP(2,2) 
Complex(dp) :: AmpTreeZhhToAhVP(2,2),AmpWaveZhhToAhVP(2,2),AmpVertexZhhToAhVP(2,2) 
Real(dp) :: AmpSqhhToAhVP(2),  AmpSqTreehhToAhVP(2) 
...
Call Amplitude_Tree_THDMIIIHB_hhToAhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhToAhAh)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhToAhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhToAhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,               & 
& MRPhhToAhAh,MRGhhToAhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,              & 
& MRPhhToAhAh,MRGhhToAhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPhhToAhAh,       & 
& MRGhhToAhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,MRPhhToAhAh,      & 
& MRGhhToAhAh)
...
Call Amplitude_WAVE_THDMIIIHB_hhToAhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,Mhh,            & 
& Mhh2,ZfAh,Zfhh,AmpWavehhToAhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,        & 
& cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,             & 
& cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& AmpVertexIRdrhhToAhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToAhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
...
& cplAhhhhhsigma11,cplAhhhHmcHm1,cplAhhhsigma1sigma11,AmpVertexIRoshhToAhAh)
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MhhOS(gt1).gt.(MAhOS+MAhOS))).or.((.not.OSkinematics).and.(Mhh(gt1).gt.(MAh+MAh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1 
  AmpSum2hhToAhAh = AmpTreehhToAhAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MhhOS(gt1),MAhOS,MAhOS,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
Else  
  Call SquareAmp_StoSS(Mhh(gt1),MAh,MAh,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqhhToAhAh(gt1) 
...
Else  
  Call SquareAmp_StoSS(Mhh(gt1),MAh,MAh,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqhhToAhAh(gt1) 
...
Else  
  Call SquareAmp_StoSS(Mhh(gt1),MAh,MAh,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqhhToAhAh(gt1) 
  AmpSum2hhToAhAh = AmpTreehhToAhAh + 2._dp*AmpWavehhToAhAh + 2._dp*AmpVertexhhToAhAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MhhOS(gt1),MAhOS,MAhOS,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
Else  
  Call SquareAmp_StoSS(Mhh(gt1),MAh,MAh,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqhhToAhAh(gt1) 
 End if 
If (OSkinematics) Then 
  AmpSum2hhToAhAh = AmpTreehhToAhAh
  Call SquareAmp_StoSS(MhhOS(gt1),MAhOS,MAhOS,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
  AmpSqTreehhToAhAh(gt1) = AmpSqhhToAhAh(gt1)  
  AmpSum2hhToAhAh = + 2._dp*AmpWavehhToAhAh + 2._dp*AmpVertexhhToAhAh
  Call SquareAmp_StoSS(MhhOS(gt1),MAhOS,MAhOS,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
  AmpSqhhToAhAh(gt1) = AmpSqhhToAhAh(gt1) + AmpSqTreehhToAhAh(gt1)  
Else  
  AmpSum2hhToAhAh = AmpTreehhToAhAh
  Call SquareAmp_StoSS(Mhh(gt1),MAh,MAh,AmpSumhhToAhAh(gt1),AmpSum2hhToAhAh(gt1),AmpSqhhToAhAh(gt1)) 
  AmpSqTreehhToAhAh(gt1) = AmpSqhhToAhAh(gt1)  
...
End if  
Else  
  AmpSqhhToAhAh(gt1) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhToAhAh(gt1).le.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp/2._dp*GammaTPS(MhhOS(gt1),MAhOS,MAhOS,helfactor*AmpSqhhToAhAh(gt1))
Else 
  gP1Lhh(gt1,i4) = 1._dp/2._dp*GammaTPS(Mhh(gt1),MAh,MAh,helfactor*AmpSqhhToAhAh(gt1))
End if 
If ((Abs(MRPhhToAhAh(gt1)).gt.1.0E-20_dp).or.(Abs(MRGhhToAhAh(gt1)).gt.1.0E-20_dp)) Then 
...
If ((Abs(MRPhhToAhAh(gt1)).gt.1.0E-20_dp).or.(Abs(MRGhhToAhAh(gt1)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*1._dp/4._dp*helfactor*(MRPhhToAhAh(gt1) + MRGhhToAhAh(gt1)) 
  gP1Lhh(gt1,i4) = gP1Lhh(gt1,i4) + phasespacefactor*1._dp/4._dp*helfactor*(MRPhhToAhAh(gt1) + MRGhhToAhAh(gt1))
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTohhAh(cplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhTohhAh)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTohhAh(ZcplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAhOS,MhhOS,               & 
& MRPhhTohhAh,MRGhhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAhOS,MhhOS,              & 
& MRPhhTohhAh,MRGhhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAh,Mhh,MRPhhTohhAh,       & 
& MRGhhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAh,Mhh,MRPhhTohhAh,      & 
& MRGhhTohhAh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTohhAh(cplAhhhhh,ctcplAhhhhh,MAh,MAh2,Mhh,            & 
& Mhh2,ZfAh,Zfhh,AmpWavehhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,        & 
& cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,             & 
& cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& cplhhhhHmcHm1,cplhhhhsigma1sigma11,AmpVertexhhTohhAh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,        & 
& cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,             & 
& cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplAhAhAhhh1,cplAhAhhhhh1,cplAhAhhhsigma11,cplAhhhhhhh1,      & 
& cplAhhhhhsigma11,cplAhhhHmcHm1,cplAhhhsigma1sigma11,cplhhhhhhhh1,cplhhhhhhsigma11,     & 
& cplhhhhHmcHm1,cplhhhhsigma1sigma11,AmpVertexIRdrhhTohhAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTohhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,     & 
& MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,              & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplAhAhAhhh1,cplAhAhhhhh1,cplAhAhhhsigma11,cplAhhhhhhh1,      & 
& cplAhhhhhsigma11,cplAhhhHmcHm1,cplAhhhsigma1sigma11,cplhhhhhhhh1,cplhhhhhhsigma11,     & 
& cplhhhhHmcHm1,cplhhhhsigma1sigma11,AmpVertexIRoshhTohhAh)
...
i4 = isave 
  Do gt2=1,2
If (((OSkinematics).and.(MhhOS(gt1).gt.(MhhOS(gt2)+MAhOS))).or.((.not.OSkinematics).and.(Mhh(gt1).gt.(Mhh(gt2)+MAh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2hhTohhAh = AmpTreehhTohhAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MhhOS(gt1),MhhOS(gt2),MAhOS,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
Else  
  Call SquareAmp_StoSS(Mhh(gt1),Mhh(gt2),MAh,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqhhTohhAh(gt1, gt2) 
...
Else  
  Call SquareAmp_StoSS(Mhh(gt1),Mhh(gt2),MAh,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqhhTohhAh(gt1, gt2) 
...
Else  
  Call SquareAmp_StoSS(Mhh(gt1),Mhh(gt2),MAh,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqhhTohhAh(gt1, gt2) 
  AmpSum2hhTohhAh = AmpTreehhTohhAh + 2._dp*AmpWavehhTohhAh + 2._dp*AmpVertexhhTohhAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MhhOS(gt1),MhhOS(gt2),MAhOS,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
Else  
  Call SquareAmp_StoSS(Mhh(gt1),Mhh(gt2),MAh,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqhhTohhAh(gt1, gt2) 
 End if 
If (OSkinematics) Then 
  AmpSum2hhTohhAh = AmpTreehhTohhAh
  Call SquareAmp_StoSS(MhhOS(gt1),MhhOS(gt2),MAhOS,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
  AmpSqTreehhTohhAh(gt1, gt2) = AmpSqhhTohhAh(gt1, gt2)  
  AmpSum2hhTohhAh = + 2._dp*AmpWavehhTohhAh + 2._dp*AmpVertexhhTohhAh
  Call SquareAmp_StoSS(MhhOS(gt1),MhhOS(gt2),MAhOS,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
  AmpSqhhTohhAh(gt1, gt2) = AmpSqhhTohhAh(gt1, gt2) + AmpSqTreehhTohhAh(gt1, gt2)  
Else  
  AmpSum2hhTohhAh = AmpTreehhTohhAh
  Call SquareAmp_StoSS(Mhh(gt1),Mhh(gt2),MAh,AmpSumhhTohhAh(gt1, gt2),AmpSum2hhTohhAh(gt1, gt2),AmpSqhhTohhAh(gt1, gt2)) 
  AmpSqTreehhTohhAh(gt1, gt2) = AmpSqhhTohhAh(gt1, gt2)  
...
End if  
Else  
  AmpSqhhTohhAh(gt1, gt2) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhTohhAh(gt1, gt2).le.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(MhhOS(gt1),MhhOS(gt2),MAhOS,helfactor*AmpSqhhTohhAh(gt1, gt2))
Else 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(Mhh(gt1),Mhh(gt2),MAh,helfactor*AmpSqhhTohhAh(gt1, gt2))
End if 
If ((Abs(MRPhhTohhAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGhhTohhAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
  phasespacefactor = 1._dp 
End if 
 If (DebugLoopDecays) Write(*,*) "virtual", gP1Lhh(gt1,i4) 
 ! Adding real corrections 
If ((Abs(MRPhhTohhAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGhhTohhAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPhhTohhAh(gt1, gt2) + MRGhhTohhAh(gt1, gt2)) 
  gP1Lhh(gt1,i4) = gP1Lhh(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPhhTohhAh(gt1, gt2) + MRGhhTohhAh(gt1, gt2))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1Lhh(gt1,i4) 
  End if 
End if 
End if 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhToAhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,               & 
& MVZ2,AmpTreehhToAhVZ)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhToAhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,              & 
& MVZ2,AmpTreehhToAhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,               & 
& MVZOS,MRPhhToAhVZ,MRGhhToAhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,              & 
& MVZOS,MRPhhToAhVZ,MRGhhToAhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,               & 
& MRPhhToAhVZ,MRGhhToAhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,MVZ,              & 
& MRPhhToAhVZ,MRGhhToAhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhToAhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,            & 
& Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWavehhToAhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToAhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,        & 
& cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,             & 
& cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& cplhhhhVZVZ1,cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,AmpVertexhhToAhVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToAhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,        & 
& cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,             & 
& cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,          & 
...
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmcHmVZ,         & 
& cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ1,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,       & 
& cplhhhhVZVZ1,cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,AmpVertexIRdrhhToAhVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToAhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,     & 
& MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,              & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MhhOS(gt1).gt.(MAhOS+MVZOS))).or.((.not.OSkinematics).and.(Mhh(gt1).gt.(MAh+MVZ)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1 
  AmpSum2hhToAhVZ = AmpTreehhToAhVZ
If (OSkinematics) Then 
  Call SquareAmp_StoSV(MhhOS(gt1),MAhOS,MVZOS,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
Else  
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVZ,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqhhToAhVZ(gt1) 
...
Else  
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVZ,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqhhToAhVZ(gt1) 
...
Else  
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVZ,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqhhToAhVZ(gt1) 
  AmpSum2hhToAhVZ = AmpTreehhToAhVZ + 2._dp*AmpWavehhToAhVZ + 2._dp*AmpVertexhhToAhVZ
If (OSkinematics) Then 
  Call SquareAmp_StoSV(MhhOS(gt1),MAhOS,MVZOS,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
Else  
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVZ,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqhhToAhVZ(gt1) 
 End if 
If (OSkinematics) Then 
  AmpSum2hhToAhVZ = AmpTreehhToAhVZ
  Call SquareAmp_StoSV(MhhOS(gt1),MAhOS,MVZOS,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
  AmpSqTreehhToAhVZ(gt1) = AmpSqhhToAhVZ(gt1)  
  AmpSum2hhToAhVZ = + 2._dp*AmpWavehhToAhVZ + 2._dp*AmpVertexhhToAhVZ
  Call SquareAmp_StoSV(MhhOS(gt1),MAhOS,MVZOS,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
  AmpSqhhToAhVZ(gt1) = AmpSqhhToAhVZ(gt1) + AmpSqTreehhToAhVZ(gt1)  
Else  
  AmpSum2hhToAhVZ = AmpTreehhToAhVZ
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVZ,AmpSumhhToAhVZ(:,gt1),AmpSum2hhToAhVZ(:,gt1),AmpSqhhToAhVZ(gt1)) 
  AmpSqTreehhToAhVZ(gt1) = AmpSqhhToAhVZ(gt1)  
...
End if  
Else  
  AmpSqhhToAhVZ(gt1) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhToAhVZ(gt1).le.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(MhhOS(gt1),MAhOS,MVZOS,helfactor*AmpSqhhToAhVZ(gt1))
Else 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(Mhh(gt1),MAh,MVZ,helfactor*AmpSqhhToAhVZ(gt1))
End if 
If ((Abs(MRPhhToAhVZ(gt1)).gt.1.0E-20_dp).or.(Abs(MRGhhToAhVZ(gt1)).gt.1.0E-20_dp)) Then 
  phasespacefactor = 1._dp 
End if 
 If (DebugLoopDecays) Write(*,*) "virtual", gP1Lhh(gt1,i4) 
 ! Adding real corrections 
If ((Abs(MRPhhToAhVZ(gt1)).gt.1.0E-20_dp).or.(Abs(MRGhhToAhVZ(gt1)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*1._dp*helfactor*(MRPhhToAhVZ(gt1) + MRGhhToAhVZ(gt1)) 
  gP1Lhh(gt1,i4) = gP1Lhh(gt1,i4) + phasespacefactor*1._dp*helfactor*(MRPhhToAhVZ(gt1) + MRGhhToAhVZ(gt1))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1Lhh(gt1,i4) 
  End if 
End if 
End if 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,              & 
& MFd2,Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,            & 
& MFd2,Mhh2,AmpTreehhTocFdFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,            & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,          & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,        & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTocFdFd(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFdFd(MAh,MFd,MFu,Mhh,MHm,Msigma1,             & 
...
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFdFd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFdFd(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,           & 
...
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,            & 
& cplcFdFuVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhTocFdFd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,              & 
& MFe2,Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,            & 
& MFe2,Mhh2,AmpTreehhTocFeFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,            & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,          & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,        & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTocFeFe(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,           & 
& MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,    & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,             & 
...
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexhhTocFeFe)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFeFe(MAh,MFe,Mhh,MHm,Msigma1,MVP,             & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L, & 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,          & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFeFe)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFeFe(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,       & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,ZcplcFeFehhL,      & 
& ZcplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,      & 
& cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,         & 
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,              & 
& cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,        & 
...
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFeFe(MAh,MFe,Mhh,MHm,Msigma1,MVP,             & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,ZcplcFeFehhL,ZcplcFeFehhR,               & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,              & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhTocFeFe)
...
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFeFe(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,       & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFeFehhL,       & 
...
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,         & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhTocFeFe)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,              & 
& MFu2,Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,            & 
& MFu2,Mhh2,AmpTreehhTocFuFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,            & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,          & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,        & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTocFuFu(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,     & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFuFu(MAh,MFd,MFu,Mhh,MHm,Msigma1,             & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrhhTocFuFu)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocFuFu(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,           & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhsigma1,    & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,             & 
& cplcFuFdcVWmR,ZcplcFuFuhhL,ZcplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,       & 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,               & 
& cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,        & 
...
& ZcplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,      & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,          & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRoshhTocFuFu)
...
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhsigma1,    & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,             & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,         & 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,               & 
& cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,        & 
& AmpVertexIRoshhTocFuFu)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,         & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,        & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,           & 
& MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,          & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,           & 
& AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,        & 
& cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,               & 
...
& cplhhhhhhsigma11,cplhhhhHmcHm1,cplhhhhsigma1sigma11,cplhhhhcVWmVWm1,cplhhhhVZVZ1,      & 
& AmpVertexhhTohhhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,        & 
& cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,cplhhhhhh,              & 
& cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,      & 
...
& AmpVertexIRdrhhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTohhhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,     & 
& MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,           & 
& cplcgZgZhh,Zcplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,          & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplAhAhhhhh1,cplAhhhhhhh1,            & 
& cplAhhhhhsigma11,cplhhhhhhhh1,cplhhhhhhsigma11,cplhhhhHmcHm1,cplhhhhsigma1sigma11,     & 
& cplhhhhcVWmVWm1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
& MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,           & 
& cplcgZgZhh,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,           & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplAhAhhhhh1,cplAhhhhhhh1,            & 
& cplAhhhhhsigma11,cplhhhhhhhh1,cplhhhhhhsigma11,cplhhhhHmcHm1,cplhhhhsigma1sigma11,     & 
& cplhhhhcVWmVWm1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTocHmHm(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTocHmHm(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,             & 
& MRPhhTocHmHm,MRGhhTocHmHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,            & 
& MRPhhTocHmHm,MRGhhTocHmHm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,    & 
& MRGhhTocHmHm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,   & 
& MRGhhTocHmHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTocHmHm(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,             & 
& MHm,MHm2,Zfhh,ZfHm,AmpWavehhTocHmHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,      & 
...
& cplcFeFvHmR,cplcgWmgWmhh,cplcgZgWmcHm,cplcgWpCgWpChh,cplcgZgWpCHm,cplcgZgZhh,          & 
& cplcgWmgZHm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,              & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,     & 
...
& cplhhHmsigma1cHm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,         & 
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexhhTocHmHm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,         & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,      & 
& cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,              & 
...
& cplcHmVPVWm,cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplhhhhHmcHm1,   & 
& cplhhHmsigma1cHm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,         & 
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrhhTocHmHm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocHmHm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,            & 
...
& cplhhhhhh,cplhhhhsigma1,ZcplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,       & 
...
& cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplhhhhHmcHm1,cplhhHmsigma1cHm1,         & 
& cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,cplHmHmcHmcHm1,            & 
& cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRoshhTocHmHm)
...
& cplcFvFecHmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,              & 
& cplcFeFvHmR,cplcgWmgWmhh,cplcgZgWmcHm,cplcgWpCgWpChh,cplcgZgWpCHm,cplcgZgZhh,          & 
& cplcgWmgZHm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,ZcplhhHmcHm,cplhhHmcVWm,             & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,     & 
& cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,         & 
& cplcHmVPVWm,cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplhhhhHmcHm1,   & 
& cplhhHmsigma1cHm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,         & 
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRoshhTocHmHm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhToHmcVWm(cplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,               & 
& MHm2,MVWm2,AmpTreehhToHmcVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhToHmcVWm(ZcplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,              & 
& MHm2,MVWm2,AmpTreehhToHmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,MhhOS,MHmOS,           & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,MhhOS,MHmOS,          & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,Mhh,MHm,               & 
& MVWm,MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,Mhh,MHm,              & 
& MVWm,MRPhhToHmcVWm,MRGhhToHmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhToHmcVWm(cplhhHmcVWm,ctcplhhHmcVWm,Mhh,               & 
& Mhh2,MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWavehhToHmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,           & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,      & 
...
& cplcgZgAhh,cplcgWmgAHm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,        & 
& cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpCgZcVWm,cplhhhhhh,cplhhhhsigma1,            & 
...
& cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,   & 
& cplhhHmcVWmVZ1,cplHmsigma1cVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexhhToHmcVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,        & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,      & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,               & 
...
& cplhhVZVZ,cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,            & 
& cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,   & 
& cplhhHmcVWmVZ1,cplHmsigma1cVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRdrhhToHmcVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToHmcVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,          & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,            & 
...
& cplcgWpCgZcVWm,cplhhhhhh,cplhhhhsigma1,GosZcplhhHmcHm,ZcplhhHmcVWm,cplhhsigma1sigma1,  & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,cplHmsigma1cVWm,       & 
& cplHmcHmVP,GosZcplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,           & 
& cplAhHmcVWmVZ1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplHmsigma1cVWmVZ1,       & 
...
& cplcgZgAhh,cplcgWmgAHm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,        & 
& cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpCgZcVWm,cplhhhhhh,cplhhhhsigma1,            & 
& GZcplhhHmcHm,ZcplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,    & 
& cplhhVZVZ,cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,GZcplHmcVWmVP,cplHmcHmVZ,          & 
& cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,   & 
& cplhhHmcVWmVZ1,cplHmsigma1cVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRoshhToHmcVWm)
...
& cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,cplcgZgAhh,cplcgWmgAHm,cplcgWmgWmhh,   & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,cplcgZgWpCHm,cplcgZgZhh,cplcgWmgZHm,        & 
& cplcgWpCgZcVWm,cplhhhhhh,cplhhhhsigma1,GcplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,      & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,cplHmsigma1cVWm,       & 
...
i4 = isave 
  Do gt2=2,2
If (((OSkinematics).and.(MhhOS(gt1).gt.(MHmOS(gt2)+MVWmOS))).or.((.not.OSkinematics).and.(Mhh(gt1).gt.(MHm(gt2)+MVWm)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2hhToHmcVWm = AmpTreehhToHmcVWm
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhToHmcVWm(gt1, gt2).le.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,           & 
& AmpTreehhTocVWmVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhTocVWmVWm(ZcplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,          & 
& AmpTreehhTocVWmVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,MhhOS,               & 
& MVWmOS,MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,MhhOS,              & 
& MVWmOS,MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,MVWm,            & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,Mhh,MVWm,           & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,Mhh,            & 
& Mhh2,MVWm,MVWm2,Zfhh,ZfVWm,AmpWavehhTocVWmVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTocVWmVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,     & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,       & 
...
& cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cVWm,cplHmcVWmVP,cplHmcVWmVZ,            & 
& cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,     & 
& cplhhhhcVWmVWm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,           & 
& cplHmcHmcVWmVWm1,cplsigma1sigma1cVWmVWm1,cplcVWmcVWmVWmVWm1Q,cplcVWmcVWmVWmVWm2Q,      & 
& cplcVWmcVWmVWmVWm3Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexhhTocVWmVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocVWmVWm(MAh,MFd,MFe,MFu,Mhh,MHm,               & 
...
& cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhTocVWmVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhTocVWmVWm(MAhOS,MFdOS,MFeOS,MFuOS,               & 
& MhhOS,MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,             & 
& MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,               & 
...
& cplhhhhsigma1,GosZcplhhHmcHm,GosZcplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,          & 
& GosZcplhhcHmVWm,ZcplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cVWm,GosZcplHmcVWmVP,               & 
& cplHmcVWmVZ,cplsigma1cHmVWm,GosZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,     & 
& cplAhAhcVWmVWm1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,          & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplsigma1sigma1cVWmVWm1,cplcVWmcVWmVWmVWm1Q,           & 
& cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,             & 
...
& cplcFeFvVWmR,cplcgZgAhh,cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmhh,cplcgAgWmcVWm,        & 
& cplcgZgWmcVWm,cplcgWpCgWpChh,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZgZhh,cplcgWmgZVWm,      & 
& cplcgWpCgZcVWm,cplhhhhhh,cplhhhhsigma1,GZcplhhHmcHm,GZcplhhHmcVWm,cplhhsigma1sigma1,   & 
& cplhhsigma1VZ,GZcplhhcHmVWm,ZcplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cVWm,GZcplHmcVWmVP,     & 
& cplHmcVWmVZ,cplsigma1cHmVWm,GZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,       & 
& cplAhAhcVWmVWm1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,          & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplsigma1sigma1cVWmVWm1,cplcVWmcVWmVWmVWm1Q,           & 
& cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,             & 
& cplcVWmVWmVZVZ1Q,AmpVertexIRoshhTocVWmVWm)
...
& cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmhh,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpCgWpChh,   & 
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZgZhh,cplcgWmgZVWm,cplcgWpCgZcVWm,cplhhhhhh,          & 
& cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,GcplhhcHmVWm,     & 
& cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cVWm,cplHmcVWmVP,cplHmcVWmVZ,cplsigma1cHmVWm,        & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_THDMIIIHB_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,               & 
& MRPhhToVZVZ,MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,              & 
& MRPhhToVZVZ,MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,       & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,      & 
& MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,MVZ,            & 
& MVZ2,Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhhh,cplAhhhsigma1,    & 
...
& cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,        & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ1,cplhhhhVZVZ1,             & 
& cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmVZVZ1,cplsigma1sigma1VZVZ1,cplcVWmVWmVZVZ2Q,     & 
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexhhToVZVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhhh,cplAhhhsigma1,    & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,     & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,          & 
...
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_hhToVZVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,     & 
& MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,              & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,             & 
& cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,      & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,ZcplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,              & 
& cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ1,cplhhhhVZVZ1,cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,      & 
& cplHmcHmVZVZ1,cplsigma1sigma1VZVZ1,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q, & 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcgWmgWmhh,cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,          & 
& cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,ZcplhhVZVZ,       & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ1,cplhhhhVZVZ1,             & 
& cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmVZVZ1,cplsigma1sigma1VZVZ1,cplcVWmVWmVZVZ2Q,     & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,             & 
& cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,      & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,               & 
& cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ1,cplhhhhVZVZ1,cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,      & 
& cplHmcHmVZVZ1,cplsigma1sigma1VZVZ1,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q, & 
& AmpVertexIRoshhToVZVZ)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhToAhVP(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,            & 
& Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWavehhToAhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToAhVP(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MhhOS(gt1).gt.(MAhOS+0.))).or.((.not.OSkinematics).and.(Mhh(gt1).gt.(MAh+MVP)))) Then 
If (OSkinematics) Then 
  Call SquareAmp_StoSV(MhhOS(gt1),MAhOS,0._dp,AmpSumhhToAhVP(:,gt1),AmpSum2hhToAhVP(:,gt1),AmpSqhhToAhVP(gt1)) 
Else  
  Call SquareAmp_StoSV(Mhh(gt1),MAh,MVP,AmpSumhhToAhVP(:,gt1),AmpSum2hhToAhVP(:,gt1),AmpSqhhToAhVP(gt1)) 
End if  
Else  
  AmpSqhhToAhVP(gt1) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhToAhVP(gt1).le.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(MhhOS(gt1),MAhOS,0._dp,helfactor*AmpSqhhToAhVP(gt1))
Else 
  gP1Lhh(gt1,i4) = 1._dp*GammaTPS(Mhh(gt1),MAh,MVP,helfactor*AmpSqhhToAhVP(gt1))
End if 
If ((Abs(MRPhhToAhVP(gt1)).gt.1.0E-20_dp).or.(Abs(MRGhhToAhVP(gt1)).gt.1.0E-20_dp)) Then 
  phasespacefactor = 1._dp 
End if 
 If (DebugLoopDecays) Write(*,*) "virtual", gP1Lhh(gt1,i4) 
End if 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhToFvcFv(MFeOS,MhhOS,MHmOS,MVWmOS,MVZOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToFvcFv(MFe,Mhh,MHm,MVWm,MVZ,MFe2,Mhh2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,Msigma1OS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,     & 
& MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,cplcgWmgWmVZ,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhTohhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,        & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhToVGVG(MFdOS,MFuOS,MhhOS,MVG,MFd2OS,MFu2OS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,Mhh2,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhToVPVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
& MVP,MVWmOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,cplcFdFdhhL,cplcFdFdhhR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,             & 
& cplcgWpCgWpChh,cplcgWpCgWpCVP,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToVPVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,           & 
& MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWpCgWpChh,cplcgWpCgWpCVP,       & 
& cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,cplHmcVWmVP,cplcHmVPVWm,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_hhToVPVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_hhToVPVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,            & 
...
End Module Wrapper_OneLoopDecay_hh_THDMIIIHB
