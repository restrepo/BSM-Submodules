...
Module Wrapper_OneLoopDecay_Hm_THDMIIIHB
Use Model_Data_THDMIIIHB 
Use Kinematics 
Use OneLoopDecay_Hm_THDMIIIHB 
Use Control 
Use Settings 
...
& ZfER,ZfVPVZ,ZfVZVP,cplAhAhAh,cplAhAhcVWmVWm1,cplAhAhhh,cplAhAhHmcHm1,cplAhAhsigma1,    & 
& cplAhcHmVPVWm1,cplAhcHmVWm,cplAhcHmVWmVZ1,cplAhhhhh,cplAhhhHmcHm1,cplAhhhsigma1,       & 
& cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhHmsigma1cHm1,      & 
& cplAhsigma1sigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,     & 
...
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,cplcFeFeVPL,       & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,              & 
& cplcFeFvVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,        & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,       & 
...
& cplcgWmgWmAh,cplcgWmgWmhh,cplcgWmgWmsigma1,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZHm,      & 
& cplcgWmgZVWm,cplcgWpCgAcHm,cplcgWpCgWpCAh,cplcgWpCgWpChh,cplcgWpCgWpCsigma1,           & 
& cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcHm,cplcgZgAhh,cplcgZgWmcHm,cplcgZgWpCHm,      & 
& cplcgZgWpCVWm,cplcgZgZhh,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,    & 
...
& cplhhcHmVWm,cplhhcHmVWmVZ1,cplhhcVWmVWm,cplhhhhcVWmVWm1,cplhhhhhh,cplhhhhHmcHm1,       & 
& cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhHmsigma1cHm1,  & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhVZVZ,cplHmcHmcVWmVWm1,cplHmcHmVP,cplHmcHmVPVP1,   & 
& cplHmcHmVPVZ1,cplHmcHmVZ,cplHmcHmVZVZ1,cplHmcVWmVP,cplHmcVWmVZ,cplHmHmcHmcHm1,         & 
& cplHmsigma1cHm,cplHmsigma1cVWm,cplHmsigma1cVWmVP1,cplHmsigma1cVWmVZ1,cplHmsigma1sigma1cHm1,& 
& cplsigma1cHmVPVWm1,cplsigma1cHmVWm,cplsigma1cHmVWmVZ1,cplsigma1sigma1cVWmVWm1,         & 
& cplsigma1sigma1sigma1,ctcplAhcHmVWm,ctcplAhHmcHm,ctcplcFuFdcHmL,ctcplcFuFdcHmR,        & 
& ctcplcFvFecHmL,ctcplcFvFecHmR,ctcplcHmVPVWm,ctcplcHmVWmVZ,ctcplhhcHmVWm,               & 
& ctcplhhHmcHm,ctcplHmcHmVP,ctcplHmcHmVZ,ctcplHmsigma1cHm,ctcplsigma1cHmVWm,             & 
& GcplAhHmcHm,GcplcHmVPVWm,GcplhhHmcHm,GcplHmcHmVZ,GcplHmcVWmVP,GcplHmsigma1cHm,         & 
& GosZcplAhHmcHm,GosZcplcHmVPVWm,GosZcplhhHmcHm,GosZcplHmcHmVZ,GosZcplHmcVWmVP,          & 
& GosZcplHmsigma1cHm,GZcplAhHmcHm,GZcplcHmVPVWm,GZcplhhHmcHm,GZcplHmcHmVZ,               & 
& GZcplHmcVWmVP,GZcplHmsigma1cHm,ZcplAhcHmVWm,ZcplAhHmcHm,ZcplcFuFdcHmL,ZcplcFuFdcHmR,   & 
& ZcplcFvFecHmL,ZcplcFvFecHmR,ZcplcHmVWmVZ,ZcplhhcHmVWm,ZcplhhHmcHm,ZcplHmcHmVZ,         & 
& ZcplHmsigma1cHm,Zcplsigma1cHmVWm,ZRUZH,ZRUZP,ZRUVd,ZRUUd,ZRUVu,ZRUUu,ZRUVe,            & 
& ZRUUe,MLambda,em,gs,deltaM,kont,gP1LHm)
...
Complex(dp),Intent(in) :: cplAhAhAh,cplAhAhcVWmVWm1,cplAhAhhh(2),cplAhAhHmcHm1(2,2),cplAhAhsigma1,              & 
& cplAhcHmVPVWm1(2),cplAhcHmVWm(2),cplAhcHmVWmVZ1(2),cplAhhhhh(2,2),cplAhhhHmcHm1(2,2,2),& 
& cplAhhhsigma1(2),cplAhhhVZ(2),cplAhHmcHm(2,2),cplAhHmcVWm(2),cplAhHmcVWmVP1(2),        & 
& cplAhHmcVWmVZ1(2),cplAhHmsigma1cHm1(2,2),cplAhsigma1sigma1,cplcFdFdAhL(3,3),           & 
...
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWpCVWm,cplcgWmgWmAh,       & 
& cplcgWmgWmhh(2),cplcgWmgWmsigma1,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgZHm(2),             & 
& cplcgWmgZVWm,cplcgWpCgAcHm(2),cplcgWpCgWpCAh,cplcgWpCgWpChh(2),cplcgWpCgWpCsigma1,     & 
& cplcgWpCgWpCVP,cplcgWpCgWpCVZ,cplcgWpCgZcHm(2),cplcgZgAhh(2),cplcgZgWmcHm(2),          & 
& cplcgZgWpCHm(2),cplcgZgWpCVWm,cplcgZgZhh(2),cplcHmVPVWm(2),cplcHmVWmVZ(2),             & 
...
& cplhhhhsigma1(2,2),cplhhHmcHm(2,2,2),cplhhHmcVWm(2,2),cplhhHmcVWmVP1(2,2),             & 
& cplhhHmcVWmVZ1(2,2),cplhhHmsigma1cHm1(2,2,2),cplhhsigma1sigma1(2),cplhhsigma1VZ(2),    & 
...
& cplsigma1sigma1cVWmVWm1,cplsigma1sigma1sigma1,ctcplAhcHmVWm(2),ctcplAhHmcHm(2,2),      & 
& ctcplcFuFdcHmL(3,3,2),ctcplcFuFdcHmR(3,3,2),ctcplcFvFecHmL(3,3,2),ctcplcFvFecHmR(3,3,2),& 
& ctcplcHmVPVWm(2),ctcplcHmVWmVZ(2),ctcplhhcHmVWm(2,2),ctcplhhHmcHm(2,2,2),              & 
& ctcplHmcHmVP(2,2),ctcplHmcHmVZ(2,2),ctcplHmsigma1cHm(2,2),ctcplsigma1cHmVWm(2),        & 
& GcplAhHmcHm(2,2),GcplcHmVPVWm(2),GcplhhHmcHm(2,2,2),GcplHmcHmVZ(2,2),GcplHmcVWmVP(2),  & 
& GcplHmsigma1cHm(2,2),GosZcplAhHmcHm(2,2),GosZcplcHmVPVWm(2),GosZcplhhHmcHm(2,2,2),     & 
& GosZcplHmcHmVZ(2,2),GosZcplHmcVWmVP(2),GosZcplHmsigma1cHm(2,2),GZcplAhHmcHm(2,2)

Complex(dp),Intent(in) :: GZcplcHmVPVWm(2),GZcplhhHmcHm(2,2,2),GZcplHmcHmVZ(2,2),GZcplHmcVWmVP(2),               & 
& GZcplHmsigma1cHm(2,2),ZcplAhcHmVWm(2),ZcplAhHmcHm(2,2),ZcplcFuFdcHmL(3,3,2),           & 
& ZcplcFuFdcHmR(3,3,2),ZcplcFvFecHmL(3,3,2),ZcplcFvFecHmR(3,3,2),ZcplcHmVWmVZ(2),        & 
& ZcplhhcHmVWm(2,2),ZcplhhHmcHm(2,2,2),ZcplHmcHmVZ(2,2),ZcplHmsigma1cHm(2,2),            & 
& Zcplsigma1cHmVWm(2)
...
Real(dp) :: MRPHmToHmAh(2,2),MRGHmToHmAh(2,2), MRPZHmToHmAh(2,2),MRGZHmToHmAh(2,2) 
Real(dp) :: MVPHmToHmAh(2,2) 
Real(dp) :: RMsqTreeHmToHmAh(2,2),RMsqWaveHmToHmAh(2,2),RMsqVertexHmToHmAh(2,2) 
Complex(dp) :: AmpTreeHmToHmAh(2,2),AmpWaveHmToHmAh(2,2)=(0._dp,0._dp),AmpVertexHmToHmAh(2,2)& 
 & ,AmpVertexIRosHmToHmAh(2,2),AmpVertexIRdrHmToHmAh(2,2), AmpSumHmToHmAh(2,2), AmpSum2HmToHmAh(2,2) 
Complex(dp) :: AmpTreeZHmToHmAh(2,2),AmpWaveZHmToHmAh(2,2),AmpVertexZHmToHmAh(2,2) 
Real(dp) :: AmpSqHmToHmAh(2,2),  AmpSqTreeHmToHmAh(2,2) 
Real(dp) :: MRPHmToAhVWm(2),MRGHmToAhVWm(2), MRPZHmToAhVWm(2),MRGZHmToAhVWm(2) 
Real(dp) :: MVPHmToAhVWm(2) 
Real(dp) :: RMsqTreeHmToAhVWm(2),RMsqWaveHmToAhVWm(2),RMsqVertexHmToAhVWm(2) 
Complex(dp) :: AmpTreeHmToAhVWm(2,2),AmpWaveHmToAhVWm(2,2)=(0._dp,0._dp),AmpVertexHmToAhVWm(2,2)& 
 & ,AmpVertexIRosHmToAhVWm(2,2),AmpVertexIRdrHmToAhVWm(2,2), AmpSumHmToAhVWm(2,2), AmpSum2HmToAhVWm(2,2) 
Complex(dp) :: AmpTreeZHmToAhVWm(2,2),AmpWaveZHmToAhVWm(2,2),AmpVertexZHmToAhVWm(2,2) 
Real(dp) :: AmpSqHmToAhVWm(2),  AmpSqTreeHmToAhVWm(2) 
...
Call Amplitude_Tree_THDMIIIHB_HmToHmAh(cplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeHmToHmAh)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmToHmAh(ZcplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeHmToHmAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmAh(MLambda,em,gs,cplAhHmcHm,MAhOS,MHmOS,              & 
& MRPHmToHmAh,MRGHmToHmAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmAh(MLambda,em,gs,ZcplAhHmcHm,MAhOS,MHmOS,             & 
& MRPHmToHmAh,MRGHmToHmAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmToHmAh(MLambda,em,gs,cplAhHmcHm,MAh,MHm,MRPHmToHmAh,      & 
& MRGHmToHmAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmAh(MLambda,em,gs,ZcplAhHmcHm,MAh,MHm,MRPHmToHmAh,     & 
& MRGHmToHmAh)
...
Call Amplitude_WAVE_THDMIIIHB_HmToHmAh(cplAhHmcHm,ctcplAhHmcHm,MAh,MAh2,              & 
& MHm,MHm2,ZfAh,ZfHm,AmpWaveHmToHmAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToHmAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmAh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhAh,         & 
& cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,           & 
& cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFuFdcHmL,           & 
...
& cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,          & 
& cplAhcHmVWmVZ1,cplhhhhHmcHm1,cplhhHmsigma1cHm1,cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,   & 
& AmpVertexIRdrHmToHmAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
...
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,AmpVertexIRosHmToHmAh)
...
i4 = isave 
  Do gt2=2,2
If (((OSkinematics).and.(MHmOS(gt1).gt.(MHmOS(gt2)+MAhOS))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(MHm(gt2)+MAh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2HmToHmAh = AmpTreeHmToHmAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MHmOS(gt1),MHmOS(gt2),MAhOS,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
Else  
  Call SquareAmp_StoSS(MHm(gt1),MHm(gt2),MAh,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqHmToHmAh(gt1, gt2) 
...
Else  
  Call SquareAmp_StoSS(MHm(gt1),MHm(gt2),MAh,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqHmToHmAh(gt1, gt2) 
...
Else  
  Call SquareAmp_StoSS(MHm(gt1),MHm(gt2),MAh,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqHmToHmAh(gt1, gt2) 
  AmpSum2HmToHmAh = AmpTreeHmToHmAh + 2._dp*AmpWaveHmToHmAh + 2._dp*AmpVertexHmToHmAh
If (OSkinematics) Then 
  Call SquareAmp_StoSS(MHmOS(gt1),MHmOS(gt2),MAhOS,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
Else  
  Call SquareAmp_StoSS(MHm(gt1),MHm(gt2),MAh,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqHmToHmAh(gt1, gt2) 
 End if 
If (OSkinematics) Then 
  AmpSum2HmToHmAh = AmpTreeHmToHmAh
  Call SquareAmp_StoSS(MHmOS(gt1),MHmOS(gt2),MAhOS,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
  AmpSqTreeHmToHmAh(gt1, gt2) = AmpSqHmToHmAh(gt1, gt2)  
  AmpSum2HmToHmAh = + 2._dp*AmpWaveHmToHmAh + 2._dp*AmpVertexHmToHmAh
  Call SquareAmp_StoSS(MHmOS(gt1),MHmOS(gt2),MAhOS,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
  AmpSqHmToHmAh(gt1, gt2) = AmpSqHmToHmAh(gt1, gt2) + AmpSqTreeHmToHmAh(gt1, gt2)  
Else  
  AmpSum2HmToHmAh = AmpTreeHmToHmAh
  Call SquareAmp_StoSS(MHm(gt1),MHm(gt2),MAh,AmpSumHmToHmAh(gt1, gt2),AmpSum2HmToHmAh(gt1, gt2),AmpSqHmToHmAh(gt1, gt2)) 
  AmpSqTreeHmToHmAh(gt1, gt2) = AmpSqHmToHmAh(gt1, gt2)  
...
End if  
Else  
  AmpSqHmToHmAh(gt1, gt2) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqHmToHmAh(gt1, gt2).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1LHm(gt1,i4) = 1._dp*GammaTPS(MHmOS(gt1),MHmOS(gt2),MAhOS,helfactor*AmpSqHmToHmAh(gt1, gt2))
Else 
  gP1LHm(gt1,i4) = 1._dp*GammaTPS(MHm(gt1),MHm(gt2),MAh,helfactor*AmpSqHmToHmAh(gt1, gt2))
End if 
If ((Abs(MRPHmToHmAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGHmToHmAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
...
If ((Abs(MRPHmToHmAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGHmToHmAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPHmToHmAh(gt1, gt2) + MRGHmToHmAh(gt1, gt2)) 
  gP1LHm(gt1,i4) = gP1LHm(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPHmToHmAh(gt1, gt2) + MRGHmToHmAh(gt1, gt2))
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmToAhVWm(cplAhcHmVWm,MAh,MHm,MVWm,MAh2,MHm2,           & 
& MVWm2,AmpTreeHmToAhVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmToAhVWm(ZcplAhcHmVWm,MAh,MHm,MVWm,MAh2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmToAhVWm(MLambda,em,gs,cplAhcHmVWm,MAhOS,MHmOS,            & 
& MVWmOS,MRPHmToAhVWm,MRGHmToAhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToAhVWm(MLambda,em,gs,ZcplAhcHmVWm,MAhOS,MHmOS,           & 
& MVWmOS,MRPHmToAhVWm,MRGHmToAhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmToAhVWm(MLambda,em,gs,cplAhcHmVWm,MAh,MHm,MVWm,           & 
& MRPHmToAhVWm,MRGHmToAhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToAhVWm(MLambda,em,gs,ZcplAhcHmVWm,MAh,MHm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmToAhVWm(cplAhcHmVWm,ctcplAhcHmVWm,MAh,MAh2,           & 
& MHm,MHm2,MVWm,MVWm2,ZfAh,ZfHm,ZfVWm,AmpWaveHmToAhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToAhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhAh,         & 
& cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,           & 
& cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFuFdcHmL,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToAhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,         & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhAh,         & 
& cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,           & 
& cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,cplAhcHmVWm,cplcFuFdcHmL,           & 
...
& cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,          & 
& cplAhAhcVWmVWm1,cplAhcHmVPVWm1,cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,         & 
& AmpVertexIRdrHmToAhVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToAhVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,          & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,GosZcplAhHmcHm,cplAhHmcVWm,           & 
& cplAhsigma1sigma1,ZcplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,    & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgWpCgAcHm,cplcgZgWmcHm,        & 
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,         & 
& cplhhcVWmVWm,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,GosZcplcHmVPVWm,     & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,cplAhcHmVPVWm1,cplAhcHmVWmVZ1,   & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRosHmToAhVWm)
...
& cplAhAhhh,cplAhAhsigma1,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhsigma1,           & 
& cplAhhhVZ,GZcplAhHmcHm,cplAhHmcVWm,cplAhsigma1sigma1,ZcplAhcHmVWm,cplcFuFdcHmL,        & 
& cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplcgWpCgAcHm,cplcgZgWmcHm,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWmgZVWm,      & 
& cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,cplhhcVWmVWm,cplHmsigma1cHm,cplHmcHmVP,           & 
& cplHmcHmVZ,cplsigma1cHmVWm,GZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,        & 
& cplAhAhcVWmVWm1,cplAhcHmVPVWm1,cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,         & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgWpCgAcHm,cplcgZgWmcHm,        & 
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,         & 
& cplhhcVWmVWm,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,GcplcHmVPVWm,        & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,cplAhcHmVPVWm1,cplAhcHmVWmVZ1,   & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRosHmToAhVWm)
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MHmOS(gt1).gt.(MAhOS+MVWmOS))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(MAh+MVWm)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1 
  AmpSum2HmToAhVWm = AmpTreeHmToAhVWm
If (OSkinematics) Then 
  Call SquareAmp_StoSV(MHmOS(gt1),MAhOS,MVWmOS,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
Else  
  Call SquareAmp_StoSV(MHm(gt1),MAh,MVWm,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqHmToAhVWm(gt1) 
...
Else  
  Call SquareAmp_StoSV(MHm(gt1),MAh,MVWm,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqHmToAhVWm(gt1) 
...
Else  
  Call SquareAmp_StoSV(MHm(gt1),MAh,MVWm,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqHmToAhVWm(gt1) 
  AmpSum2HmToAhVWm = AmpTreeHmToAhVWm + 2._dp*AmpWaveHmToAhVWm + 2._dp*AmpVertexHmToAhVWm
If (OSkinematics) Then 
  Call SquareAmp_StoSV(MHmOS(gt1),MAhOS,MVWmOS,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
Else  
  Call SquareAmp_StoSV(MHm(gt1),MAh,MVWm,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqHmToAhVWm(gt1) 
 End if 
If (OSkinematics) Then 
  AmpSum2HmToAhVWm = AmpTreeHmToAhVWm
  Call SquareAmp_StoSV(MHmOS(gt1),MAhOS,MVWmOS,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
  AmpSqTreeHmToAhVWm(gt1) = AmpSqHmToAhVWm(gt1)  
  AmpSum2HmToAhVWm = + 2._dp*AmpWaveHmToAhVWm + 2._dp*AmpVertexHmToAhVWm
  Call SquareAmp_StoSV(MHmOS(gt1),MAhOS,MVWmOS,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
  AmpSqHmToAhVWm(gt1) = AmpSqHmToAhVWm(gt1) + AmpSqTreeHmToAhVWm(gt1)  
Else  
  AmpSum2HmToAhVWm = AmpTreeHmToAhVWm
  Call SquareAmp_StoSV(MHm(gt1),MAh,MVWm,AmpSumHmToAhVWm(:,gt1),AmpSum2HmToAhVWm(:,gt1),AmpSqHmToAhVWm(gt1)) 
  AmpSqTreeHmToAhVWm(gt1) = AmpSqHmToAhVWm(gt1)  
...
End if  
Else  
  AmpSqHmToAhVWm(gt1) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqHmToAhVWm(gt1).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1LHm(gt1,i4) = 1._dp*GammaTPS(MHmOS(gt1),MAhOS,MVWmOS,helfactor*AmpSqHmToAhVWm(gt1))
Else 
  gP1LHm(gt1,i4) = 1._dp*GammaTPS(MHm(gt1),MAh,MVWm,helfactor*AmpSqHmToAhVWm(gt1))
End if 
If ((Abs(MRPHmToAhVWm(gt1)).gt.1.0E-20_dp).or.(Abs(MRGHmToAhVWm(gt1)).gt.1.0E-20_dp)) Then 
  phasespacefactor = 1._dp 
End if 
 If (DebugLoopDecays) Write(*,*) "virtual", gP1LHm(gt1,i4) 
 ! Adding real corrections 
If ((Abs(MRPHmToAhVWm(gt1)).gt.1.0E-20_dp).or.(Abs(MRGHmToAhVWm(gt1)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*1._dp*helfactor*(MRPHmToAhVWm(gt1) + MRGHmToAhVWm(gt1)) 
  gP1LHm(gt1,i4) = gP1LHm(gt1,i4) + phasespacefactor*1._dp*helfactor*(MRPHmToAhVWm(gt1) + MRGHmToAhVWm(gt1))
   If (DebugLoopDecays) Write(*,*) "sum",  gP1LHm(gt1,i4) 
  End if 
End if 
End if 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,            & 
& MHm,MFd2,MFu2,MHm2,AmpTreeHmTocFuFd)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmTocFuFd(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmTocFuFd(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,          & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmTocFuFd(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,        & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,     & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveHmTocFuFd)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmTocFuFd(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,            & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcHm,cplhhcHmVWm,cplHmsigma1cHm, & 
& cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexHmTocFuFd)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTocFuFd(MAh,MFd,MFu,Mhh,MHm,Msigma1,             & 
...
& AmpVertexIRdrHmTocFuFd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTocFuFd(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,           & 
...
& cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,        & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& ZcplcFuFdcHmL,ZcplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,       & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
& cplcFuFuVZL,cplcFuFuVZR,cplhhHmcHm,cplhhcHmVWm,cplHmsigma1cHm,cplHmcHmVP,              & 
& cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRosHmTocFuFd)
...
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,    & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,cplcFuFdcVWmL,         & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,     & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcHm,cplhhcHmVWm,    & 
& cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,          & 
...
i4 = isave 
  Do gt2=1,3
    Do gt3=1,3
If (((OSkinematics).and.(MHmOS(gt1).gt.(MFuOS(gt2)+MFdOS(gt3)))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(MFu(gt2)+MFd(gt3))))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2, gt3 
  AmpSum2HmTocFuFd = AmpTreeHmTocFuFd
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 4._dp 
If (AmpSqHmTocFuFd(gt1, gt2, gt3).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,MFe,MHm,            & 
& MFe2,MHm2,AmpTreeHmTocFvFe)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmTocFvFe(ZcplcFvFecHmL,ZcplcFvFecHmR,MFe,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmTocFvFe(MLambda,em,gs,cplcFvFecHmL,cplcFvFecHmR,          & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmTocFvFe(MLambda,em,gs,ZcplcFvFecHmL,ZcplcFvFecHmR,        & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,ctcplcFvFecHmL,     & 
& ctcplcFvFecHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveHmTocFvFe)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmTocFvFe(MAh,MFe,Mhh,MHm,Msigma1,MVP,MVWm,           & 
& MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTocFvFe(MAh,MFe,Mhh,MHm,Msigma1,MVP,             & 
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,             & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,cplhhcHmVWm,            & 
& cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,          & 
& AmpVertexIRdrHmTocFvFe)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTocFvFe(MAhOS,MFeOS,MhhOS,MHmOS,Msigma1OS,       & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,Msigma12OS,MVP2,MVWm2OS,MVZ2OS,           & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhHmcHm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,& 
& cplcFeFesigma1R,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,ZcplcFvFecHmL,         & 
& ZcplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,          & 
& cplhhcHmVWm,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,          & 
...
& MVWm,MVZ,MAh2,MFe2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFesigma1L,cplcFeFesigma1R,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,ZcplcFvFecHmL,ZcplcFvFecHmR,           & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,cplhhcHmVWm,            & 
& cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,          & 
& AmpVertexIRosHmTocFvFe)
...
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhHmcHm,           & 
& cplhhcHmVWm,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,          & 
& cplcHmVWmVZ,AmpVertexIRosHmTocFvFe)
...
i4 = isave 
  Do gt2=1,3
    Do gt3=1,3
If (((OSkinematics).and.(MHmOS(gt1).gt.(0.+MFeOS(gt3)))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(0.+MFe(gt3))))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2, gt3 
  AmpSum2HmTocFvFe = AmpTreeHmTocFvFe
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 4._dp 
If (AmpSqHmTocFvFe(gt1, gt2, gt3).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmToHmhh(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmToHmhh(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmhh(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,              & 
& MRPHmToHmhh,MRGHmToHmhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,             & 
& MRPHmToHmhh,MRGHmToHmhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmToHmhh(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPHmToHmhh,      & 
& MRGHmToHmhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPHmToHmhh,     & 
& MRGHmToHmhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmToHmhh(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,              & 
& MHm,MHm2,Zfhh,ZfHm,AmpWaveHmToHmhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToHmhh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
...
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexHmToHmhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmhh(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,      & 
& cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,              & 
...
& cplcHmVPVWm,cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplhhhhHmcHm1,   & 
& cplhhHmsigma1cHm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,         & 
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrHmToHmhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
...
& cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRosHmToHmhh)
...
& cplcHmVPVWm,cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmsigma1cHm1,cplhhhhHmcHm1,   & 
& cplhhHmsigma1cHm1,cplhhHmcVWmVP1,cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,         & 
& cplHmHmcHmcHm1,cplHmsigma1sigma1cHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRosHmToHmhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmTohhVWm(cplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,MHm2,           & 
& MVWm2,AmpTreeHmTohhVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmTohhVWm(ZcplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,MhhOS,MHmOS,            & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,MhhOS,MHmOS,           & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,Mhh,MHm,MVWm,           & 
& MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,Mhh,MHm,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmTohhVWm(cplhhcHmVWm,ctcplhhcHmVWm,Mhh,Mhh2,           & 
& MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWaveHmTohhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmTohhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,      & 
...
& cplcgZgWpCVWm,cplcgZgZhh,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,           & 
& cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,       & 
& cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,            & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhhhcVWmVWm1,cplhhcHmVPVWm1,   & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplsigma1cHmVWmVZ1,AmpVertexHmTohhVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTohhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,         & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhAhhh,         & 
& cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,      & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,           & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,           & 
...
& cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,            & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhhhcVWmVWm1,cplhhcHmVPVWm1,   & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplsigma1cHmVWmVZ1,AmpVertexIRdrHmTohhVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmTohhVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplAhhhhh,cplAhhhsigma1,cplAhhhVZ,            & 
...
& cplcgWmgZVWm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,GosZcplhhHmcHm,cplhhHmcVWm,         & 
& cplhhsigma1sigma1,cplhhsigma1VZ,ZcplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,    & 
& cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,GosZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,        & 
& cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhhhcVWmVWm1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,             & 
& cplHmcHmcVWmVWm1,cplsigma1cHmVWmVZ1,AmpVertexIRosHmTohhVWm)
...
& cplcgZgAhh,cplcgWpCgAcHm,cplcgWmgWmhh,cplcgZgWmcHm,cplcgWpCgWpChh,cplcgAgWpCVWm,       & 
& cplcgZgWpCVWm,cplcgZgZhh,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,           & 
& GZcplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,cplhhsigma1VZ,ZcplhhcHmVWm,cplhhcVWmVWm,    & 
& cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,GZcplcHmVPVWm,          & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhhhcVWmVWm1,cplhhcHmVPVWm1,   & 
& cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplsigma1cHmVWmVZ1,AmpVertexIRosHmTohhVWm)
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgZgAhh,cplcgWpCgAcHm,          & 
& cplcgWmgWmhh,cplcgZgWmcHm,cplcgWpCgWpChh,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZgZhh,       & 
& cplcgWmgZVWm,cplcgWpCgZcHm,cplhhhhhh,cplhhhhsigma1,GcplhhHmcHm,cplhhHmcVWm,            & 
& cplhhsigma1sigma1,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,     & 
& cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,GcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,           & 
& cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhhhcVWmVWm1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,             & 
& cplHmcHmcVWmVWm1,cplsigma1cHmVWmVZ1,AmpVertexIRosHmTohhVWm)
...
i4 = isave 
  Do gt2=1,2
If (((OSkinematics).and.(MHmOS(gt1).gt.(MhhOS(gt2)+MVWmOS))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(Mhh(gt2)+MVWm)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2HmTohhVWm = AmpTreeHmTohhVWm
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqHmTohhVWm(gt1, gt2).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmToHmVZ(cplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmToHmVZ(ZcplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHmOS,MVZOS,              & 
& MRPHmToHmVZ,MRGHmToHmVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHmOS,MVZOS,             & 
& MRPHmToHmVZ,MRGHmToHmVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,      & 
& MRGHmToHmVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,     & 
& MRGHmToHmVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmToHmVZ(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,            & 
& ctcplHmcHmVZ,MHm,MHm2,MVP,MVP2,MVZ,MVZ2,ZfHm,ZfVPVZ,ZfVZ,AmpWaveHmToHmVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToHmVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhhhVZ,         & 
& cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,               & 
...
& cplsigma1cHmVWmVZ1,AmpVertexHmToHmVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmVZ(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,          & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhhhVZ,         & 
& cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,               & 
& cplcFuFdcHmR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,            & 
& cplcFdFuHmR,cplcFuFuVZL,cplcFuFuVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFvFvVZL,               & 
...
& cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,    & 
& cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,cplHmsigma1cVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,          & 
& cplsigma1cHmVWmVZ1,AmpVertexIRdrHmToHmVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToHmVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,           & 
...
& cplcgZgWpCHm,cplcgWpCgWpCVZ,cplcgWmgZHm,cplcgWpCgZcHm,cplhhHmcHm,cplhhHmcVWm,          & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhVZVZ,cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,         & 
& cplHmcVWmVP,ZcplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,           & 
& cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,              & 
& cplHmsigma1cVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,cplsigma1cHmVWmVZ1,AmpVertexIRosHmToHmVZ)
...
& cplcFvFvVZR,cplcgWmgWmVZ,cplcgZgWmcHm,cplcgZgWpCHm,cplcgWpCgWpCVZ,cplcgWmgZHm,         & 
& cplcgWpCgZcHm,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1VZ,cplhhcHmVWm,cplhhVZVZ,              & 
& cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,ZcplHmcHmVZ,cplHmcVWmVZ,         & 
& cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,    & 
& cplhhHmcVWmVZ1,cplhhcHmVWmVZ1,cplHmsigma1cVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,          & 
& cplsigma1cHmVWmVZ1,AmpVertexIRosHmToHmVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_HmToVZVWm(cplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,MVWm2,          & 
& MVZ2,AmpTreeHmToVZVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_HmToVZVWm(ZcplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHmOS,MVWmOS,           & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHmOS,MVWmOS,          & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMIIIHB_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHm,MVWm,               & 
& MVZ,MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMIIIHB_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHm,MVWm,              & 
& MVZ,MRPHmToVZVWm,MRGHmToVZVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_HmToVZVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,        & 
& ctcplcHmVWmVZ,MHm,MHm2,MVP,MVP2,MVWm,MVWm2,MVZ,MVZ2,ZfHm,ZfVWm,ZfVZ,AmpWaveHmToVZVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToVZVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhhhVZ,         & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToVZVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,         & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhhhVZ,         & 
& cplAhHmcHm,cplAhcHmVWm,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,              & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuVWmL,cplcFdFuVWmR,           & 
& cplcFuFuVZL,cplcFuFuVZR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,             & 
...
& AmpVertexIRdrHmToVZVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_HmToVZVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,           & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhhhVZ,cplAhHmcHm,cplAhcHmVWm,cplcFdFdVZL,           & 
& cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,            & 
& cplcFvFecHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFeFvVWmL,           & 
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcgWpCgAcHm,cplcgWmgWmVZ,cplcgZgWmcHm,          & 
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWpCgWpCVZ,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,      & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,            & 
& GosZcplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,GosZcplcHmVPVWm,cplcVWmVPVWm,               & 
& ZcplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmVPVZ1,cplHmcHmcVWmVWm1,& 
& cplHmcHmVZVZ1,cplsigma1cHmVWmVZ1,cplcVWmVPVWmVZ3Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ1Q,   & 
& cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRosHmToVZVWm)
...
& cplcgWpCgAcHm,cplcgWmgWmVZ,cplcgZgWmcHm,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWpCgWpCVZ,    & 
& cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,          & 
& cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,GZcplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,          & 
& GZcplcHmVPVWm,cplcVWmVPVWm,ZcplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,    & 
& cplHmcHmVPVZ1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,cplsigma1cHmVWmVZ1,cplcVWmVPVWmVZ3Q,      & 
& cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ1Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,  & 
...
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWpCgWpCVZ,cplcgWmgZVWm,cplcgWpCgZcHm,cplhhHmcHm,      & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmsigma1cHm,cplHmcHmVP,            & 
& GcplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,GcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,         & 
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MHmOS(gt1).gt.(MVZOS+MVWmOS))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(MVZ+MVWm)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1 
  AmpSum2HmToVZVWm = AmpTreeHmToVZVWm
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqHmToVZVWm(gt1).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_HmToHmVP(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_HmToHmVP(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdVPL,         & 
...
& cplcgWpCgZcHm,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplHmsigma1cHm,cplHmsigma1cVWm,       & 
& cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplsigma1cHmVWm,cplcHmVPVWm,             & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplAhHmcVWmVP1,cplAhcHmVPVWm1,cplhhHmcVWmVP1,cplhhcHmVPVWm1,  & 
& cplHmsigma1cVWmVP1,cplHmcHmVPVP1,cplHmcHmVPVZ1,cplsigma1cHmVPVWm1,AmpVertexHmToHmVP)
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToHmVP(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhHmcHm,        & 
& cplAhHmcVWm,cplAhcHmVWm,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,cplcFdFuHmR,             & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFeFvHmL,cplcFeFvHmR,cplcgWmgWmVP,cplcgZgWmcHm,             & 
& cplcgZgWpCHm,cplcgWpCgWpCVP,cplcgWmgZHm,cplcgWpCgZcHm,cplhhHmcHm,cplhhHmcVWm,          & 
& cplhhcHmVWm,cplHmsigma1cHm,cplHmsigma1cVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,          & 
& cplHmcVWmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplAhHmcVWmVP1,       & 
& cplAhcHmVPVWm1,cplhhHmcVWmVP1,cplhhcHmVPVWm1,cplHmsigma1cVWmVP1,cplHmcHmVPVP1,         & 
& cplHmcHmVPVZ1,cplsigma1cHmVPVWm1,AmpVertexHmToHmVP)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_HmToVPVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,        & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_HmToVPVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
& MHmOS,Msigma1OS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,            & 
& Msigma12OS,MVP2,MVWm2OS,MVZ2OS,cplAhHmcHm,cplAhcHmVWm,cplcFdFdVPL,cplcFdFdVPR,         & 
...
& cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,            & 
& cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVPVWm1,cplhhcHmVPVWm1,cplHmcHmVPVP1,cplHmcHmVPVZ1,    & 
& cplHmcHmcVWmVWm1,cplsigma1cHmVPVWm1,cplcVWmVPVPVWm3Q,cplcVWmVPVPVWm1Q,cplcVWmVPVPVWm2Q,& 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_HmToVPVWm(MAh,MFd,MFe,MFu,Mhh,MHm,Msigma1,            & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,Msigma12,MVP2,MVWm2,MVZ2,cplAhHmcHm,        & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplHmsigma1cHm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,             & 
& cplsigma1cHmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVPVWm1,      & 
& cplhhcHmVPVWm1,cplHmcHmVPVP1,cplHmcHmVPVZ1,cplHmcHmcVWmVWm1,cplsigma1cHmVPVWm1,        & 
...
Do gt1=1,2
i4 = isave 
If (((OSkinematics).and.(MHmOS(gt1).gt.(0.+MVWmOS))).or.((.not.OSkinematics).and.(MHm(gt1).gt.(MVP+MVWm)))) Then 
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqHmToVPVWm(gt1).le.0._dp) Then 
  gP1LHm(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
End Module Wrapper_OneLoopDecay_Hm_THDMIIIHB
