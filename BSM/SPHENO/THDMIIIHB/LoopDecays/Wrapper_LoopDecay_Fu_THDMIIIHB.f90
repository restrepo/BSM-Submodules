...
Module Wrapper_OneLoopDecay_Fu_THDMIIIHB
Use Model_Data_THDMIIIHB 
Use Kinematics 
Use OneLoopDecay_Fu_THDMIIIHB 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Fu(MhhOS,Mhh2OS,MHmOS,MHm2OS,MFdOS,MFd2OS,MFuOS,              & 
...
& cplHmsigma1cVWm,cplsigma1cHmVWm,cplsigma1sigma1sigma1,cplVGVGVG,ctcplcFuFdcHmL,        & 
& ctcplcFuFdcHmR,ctcplcFuFdcVWmL,ctcplcFuFdcVWmR,ctcplcFuFuAhL,ctcplcFuFuAhR,            & 
& ctcplcFuFuhhL,ctcplcFuFuhhR,ctcplcFuFusigma1L,ctcplcFuFusigma1R,ctcplcFuFuVGL,         & 
...
& ZcplcFuFdcVWmR,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFuhhL,ZcplcFuFuhhR,ZcplcFuFusigma1L,   & 
& ZcplcFuFusigma1R,ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,     & 
& ZcplcFuFuVZR,ZcplcHmVPVWm,ZcplcVWmVPVWm,ZcplHmcHmVP,ZcplHmcVWmVP,ZcplVGVGVG,           & 
& ZRUZH,ZRUZP,ZRUVd,ZRUUd,ZRUVu,ZRUUu,ZRUVe,ZRUUe,MLambda,em,gs,deltaM,kont,gP1LFu)
...
& cplsigma1cHmVWm(2),cplsigma1sigma1sigma1,cplVGVGVG,ctcplcFuFdcHmL(3,3,2),              & 
& ctcplcFuFdcHmR(3,3,2),ctcplcFuFdcVWmL(3,3),ctcplcFuFdcVWmR(3,3),ctcplcFuFuAhL(3,3),    & 
& ctcplcFuFuAhR(3,3),ctcplcFuFuhhL(3,3,2),ctcplcFuFuhhR(3,3,2),ctcplcFuFusigma1L(3,3),   & 
& ctcplcFuFusigma1R(3,3),ctcplcFuFuVGL(3,3),ctcplcFuFuVGR(3,3),ctcplcFuFuVPL(3,3),       & 
& ctcplcFuFuVPR(3,3),ctcplcFuFuVZL(3,3),ctcplcFuFuVZR(3,3),GcplcFuFdcHmL(3,3,2),         & 
& GcplcFuFdcHmR(3,3,2),GcplcHmVPVWm(2),GcplHmcVWmVP(2),GosZcplcFuFdcHmL(3,3,2),          & 
& GosZcplcFuFdcHmR(3,3,2),GosZcplcHmVPVWm(2),GosZcplHmcVWmVP(2),GZcplcFuFdcHmL(3,3,2),   & 
& GZcplcFuFdcHmR(3,3,2),GZcplcHmVPVWm(2),GZcplHmcVWmVP(2),ZcplcFdFdVGL(3,3),             & 
& ZcplcFdFdVGR(3,3),ZcplcFdFdVPL(3,3),ZcplcFdFdVPR(3,3),ZcplcFdFuHmL(3,3,2),             & 
& ZcplcFdFuHmR(3,3,2),ZcplcFdFuVWmL(3,3),ZcplcFdFuVWmR(3,3),ZcplcFuFdcHmL(3,3,2),        & 
& ZcplcFuFdcHmR(3,3,2),ZcplcFuFdcVWmL(3,3),ZcplcFuFdcVWmR(3,3),ZcplcFuFuAhL(3,3),        & 
& ZcplcFuFuAhR(3,3),ZcplcFuFuhhL(3,3,2),ZcplcFuFuhhR(3,3,2),ZcplcFuFusigma1L(3,3),       & 
& ZcplcFuFusigma1R(3,3),ZcplcFuFuVGL(3,3),ZcplcFuFuVGR(3,3),ZcplcFuFuVPL(3,3),           & 
...
Real(dp) :: MRPFuToFuAh(3,3),MRGFuToFuAh(3,3), MRPZFuToFuAh(3,3),MRGZFuToFuAh(3,3) 
Real(dp) :: MVPFuToFuAh(3,3) 
Real(dp) :: RMsqTreeFuToFuAh(3,3),RMsqWaveFuToFuAh(3,3),RMsqVertexFuToFuAh(3,3) 
Complex(dp) :: AmpTreeFuToFuAh(2,3,3),AmpWaveFuToFuAh(2,3,3)=(0._dp,0._dp),AmpVertexFuToFuAh(2,3,3)& 
 & ,AmpVertexIRosFuToFuAh(2,3,3),AmpVertexIRdrFuToFuAh(2,3,3), AmpSumFuToFuAh(2,3,3), AmpSum2FuToFuAh(2,3,3) 
Complex(dp) :: AmpTreeZFuToFuAh(2,3,3),AmpWaveZFuToFuAh(2,3,3),AmpVertexZFuToFuAh(2,3,3) 
Real(dp) :: AmpSqFuToFuAh(3,3),  AmpSqTreeFuToFuAh(3,3) 
...
Call Amplitude_Tree_THDMIIIHB_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,               & 
& MAh2,MFu2,AmpTreeFuToFuAh)

  Else 
Call Amplitude_Tree_THDMIIIHB_FuToFuAh(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,MFu,             & 
& MAh2,MFu2,AmpTreeFuToFuAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,             & 
& MAhOS,MFuOS,MRPFuToFuAh,MRGFuToFuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuAh(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,           & 
& MAhOS,MFuOS,MRPFuToFuAh,MRGFuToFuAh)
...
Call Amplitude_WAVE_THDMIIIHB_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,         & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfUL,ZfUR,AmpWaveFuToFuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,             & 
...
& cplcFuFuVZR,AmpVertexFuToFuAh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,Msigma1,              & 
...
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,       & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,AmpVertexIRdrFuToFuAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuAh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,            & 
...
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,       & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,AmpVertexIRosFuToFuAh)
...
i4 = isave 
  Do gt2=1,3
If (((OSkinematics).and.(MFuOS(gt1).gt.(MFuOS(gt2)+MAhOS))).or.((.not.OSkinematics).and.(MFu(gt1).gt.(MFu(gt2)+MAh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2FuToFuAh = AmpTreeFuToFuAh
If (OSkinematics) Then 
  Call SquareAmp_FtoFS(MFuOS(gt1),MFuOS(gt2),MAhOS,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
Else  
  Call SquareAmp_FtoFS(MFu(gt1),MFu(gt2),MAh,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x TREE: ",AmpSqFuToFuAh(gt1, gt2) 
...
Else  
  Call SquareAmp_FtoFS(MFu(gt1),MFu(gt2),MAh,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x WAVE: ",AmpSqFuToFuAh(gt1, gt2) 
...
Else  
  Call SquareAmp_FtoFS(MFu(gt1),MFu(gt2),MAh,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x VERTEX: ",AmpSqFuToFuAh(gt1, gt2) 
  AmpSum2FuToFuAh = AmpTreeFuToFuAh + 2._dp*AmpWaveFuToFuAh + 2._dp*AmpVertexFuToFuAh
If (OSkinematics) Then 
  Call SquareAmp_FtoFS(MFuOS(gt1),MFuOS(gt2),MAhOS,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
Else  
  Call SquareAmp_FtoFS(MFu(gt1),MFu(gt2),MAh,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
End if  
  Write(*,*) "TREE x (TREE+WAVE+VERTEX): ",AmpSqFuToFuAh(gt1, gt2) 
 End if 
If (OSkinematics) Then 
  AmpSum2FuToFuAh = AmpTreeFuToFuAh
  Call SquareAmp_FtoFS(MFuOS(gt1),MFuOS(gt2),MAhOS,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
  AmpSqTreeFuToFuAh(gt1, gt2) = AmpSqFuToFuAh(gt1, gt2)  
  AmpSum2FuToFuAh = + 2._dp*AmpWaveFuToFuAh + 2._dp*AmpVertexFuToFuAh
  Call SquareAmp_FtoFS(MFuOS(gt1),MFuOS(gt2),MAhOS,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
  AmpSqFuToFuAh(gt1, gt2) = AmpSqFuToFuAh(gt1, gt2) + AmpSqTreeFuToFuAh(gt1, gt2)  
Else  
  AmpSum2FuToFuAh = AmpTreeFuToFuAh
  Call SquareAmp_FtoFS(MFu(gt1),MFu(gt2),MAh,AmpSumFuToFuAh(:,gt1, gt2),AmpSum2FuToFuAh(:,gt1, gt2),AmpSqFuToFuAh(gt1, gt2)) 
  AmpSqTreeFuToFuAh(gt1, gt2) = AmpSqFuToFuAh(gt1, gt2)  
...
End if  
Else  
  AmpSqFuToFuAh(gt1, gt2) = 0._dp 
End if  

! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFuToFuAh(gt1, gt2).le.0._dp) Then 
  gP1LFu(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFuOS(gt1),MFuOS(gt2),MAhOS,helfactor*AmpSqFuToFuAh(gt1, gt2))
Else 
  gP1LFu(gt1,i4) = 1._dp*GammaTPS(MFu(gt1),MFu(gt2),MAh,helfactor*AmpSqFuToFuAh(gt1, gt2))
End if 
If ((Abs(MRPFuToFuAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGFuToFuAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
...
If ((Abs(MRPFuToFuAh(gt1, gt2)).gt.1.0E-20_dp).or.(Abs(MRGFuToFuAh(gt1, gt2)).gt.1.0E-20_dp)) Then 
 If (.not.OnlyTreeLevelContributions) Then 
   If (DebugLoopDecays) Write(*,*) "real", phasespacefactor*0.5_dp*helfactor*(MRPFuToFuAh(gt1, gt2) + MRGFuToFuAh(gt1, gt2)) 
  gP1LFu(gt1,i4) = gP1LFu(gt1,i4) + phasespacefactor*0.5_dp*helfactor*(MRPFuToFuAh(gt1, gt2) + MRGFuToFuAh(gt1, gt2))
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,            & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)

  Else 
Call Amplitude_Tree_THDMIIIHB_FuToFdcHm(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,          & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFdcHm(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,        & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,     & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFuToFdcHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,            & 
...
& cplHmcHmVP,cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexFuToFdcHm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,Msigma1,             & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& AmpVertexIRdrFuToFdcHm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcHm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,           & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
...
& cplHmcHmVZ,cplsigma1cHmVWm,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRosFuToFdcHm)
...
! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFuToFdcHm(gt1, gt2, gt3).le.0._dp) Then 
  gP1LFu(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,MFd,             & 
& MFu,MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)

  Else 
Call Amplitude_Tree_THDMIIIHB_FuToFdcVWm(ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFdcVWm(MLambda,em,gs,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,     & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,ctcplcFuFdcVWmL, & 
& ctcplcFuFdcVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFuToFdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,Msigma1,               & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,     & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcVWm,               & 
& cplhhcVWmVWm,cplHmsigma1cVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,        & 
& AmpVertexFuToFdcVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,Msigma1,            & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
...
& AmpVertexIRdrFuToFdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFdcVWm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,          & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,              & 
& cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,       & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,GosZcplcFuFdcHmL,          & 
& GosZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,& 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,           & 
& cplcFuFuVZR,cplhhHmcVWm,cplhhcVWmVWm,cplHmsigma1cVWm,GosZcplHmcVWmVP,cplHmcVWmVZ,      & 
...
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,               & 
& cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,       & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,GZcplcFuFdcHmL,GZcplcFuFdcHmR,ZcplcFuFdcVWmL,      & 
& ZcplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,    & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplhhHmcVWm,               & 
& cplhhcVWmVWm,cplHmsigma1cVWm,GZcplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,      & 
...
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,              & 
& cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdsigma1L,cplcFdFdsigma1R,cplcFdFdVGL,       & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,GcplcFuFdcHmL,             & 
& GcplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFusigma1L,     & 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,           & 
& cplcFuFuVZR,cplhhHmcVWm,cplhhcVWmVWm,cplHmsigma1cVWm,GcplHmcVWmVP,cplHmcVWmVZ,         & 
& cplcVWmVPVWm,cplcVWmVWmVZ,AmpVertexIRosFuToFdcVWm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,               & 
& MFu2,Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_THDMIIIHB_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,             & 
& MFu2,Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,             & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,           & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,         & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,             & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexFuToFuhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,Msigma1,              & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
...
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRdrFuToFuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuhh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,            & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
...
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhhhhh,cplhhhhsigma1,cplhhHmcHm,cplhhHmcVWm,cplhhsigma1sigma1,          & 
& cplhhsigma1VZ,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMIIIHB_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,               & 
& MFu2,MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_THDMIIIHB_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,             & 
& MFu2,MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,             & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMIIIHB_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,           & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMIIIHB_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,               & 
...
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexFuToFuVZ)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,Msigma1,              & 
& MVG,MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,               & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,   & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplhhsigma1VZ,cplhhVZVZ,             & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFuToFuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMIIIHB_FuToFuVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,            & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,    & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,           & 
...
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,       & 
& cplcFdFuVWmL,cplcFdFuVWmR,ZcplcFuFuVZL,ZcplcFuFuVZR,cplhhsigma1VZ,cplhhVZVZ,           & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFuToFuVZ)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,       & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_THDMIIIHB_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,         & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFdFdVGL,ZcplcFdFdVGR,          & 
& ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFuFuhhL,ZcplcFuFuhhR,   & 
& ZcplcFdFuHmL,ZcplcFdFuHmR,ZcplcFuFusigma1L,ZcplcFuFusigma1R,ZcplcFuFuVGL,              & 
& ZcplcFuFuVGR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuFuVZL,       & 
& ZcplcFuFuVZR,ZcplVGVGVG,AmpVertexFuToFuVG)

 Else 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVGL,cplcFdFdVGR,              & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,         & 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplVGVGVG,AmpVertexFuToFuVG)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMIIIHB_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,        & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_THDMIIIHB_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFdFdVPL,ZcplcFdFdVPR,          & 
& ZcplcFuFdcHmL,ZcplcFuFdcHmR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFuFuhhL,ZcplcFuFuhhR,   & 
& ZcplcFdFuHmL,ZcplcFdFuHmR,ZcplcFuFusigma1L,ZcplcFuFusigma1R,ZcplcFuFuVGL,              & 
& ZcplcFuFuVGR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuFuVZL,       & 
& ZcplcFuFuVZR,ZcplHmcHmVP,ZcplHmcVWmVP,ZcplcHmVPVWm,ZcplcVWmVPVWm,AmpVertexFuToFuVP)

 Else 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& Msigma1OS,MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,Msigma12OS,          & 
& MVG2,MVP2,MVWm2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVPL,cplcFdFdVPR,              & 
& cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,       & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMIIIHB_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,Msigma1,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,Msigma12,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFusigma1L,         & 
& cplcFuFusigma1R,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,          & 
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplHmcHmVP,cplHmcVWmVP,cplcHmVPVWm,               & 
...
End Module Wrapper_OneLoopDecay_Fu_THDMIIIHB
