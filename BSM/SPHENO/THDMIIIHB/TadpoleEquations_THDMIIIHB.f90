...
& Lam2,Yu,epYU,Yd,Ye,epYD,epYE,M12,M112,M222,v,v2,Tad1Loop)
...
M112 = (-(Lam1*v**4) - Lam6*v**3*v2 + 2*M222*v2**2 + Lam7*v*v2**3 + Lam2*v2**4 -             & 
&  v**3*v2*Conjg(Lam6) + v*v2**3*Conjg(Lam7) + 2*v*Tad1Loop(1) - 2*v2*Tad1Loop(2))/(2._dp*v**2)
M12 = (Lam6*v**3 + 4*M222*v2 + 2*Lam3*v**2*v2 + 2*Lam4*v**2*v2 + Lam5*v**2*v2 +             & 
&  3*Lam7*v*v2**2 + 2*Lam2*v2**3 + v**2*v2*Conjg(Lam5) + v**3*Conjg(Lam6) +              & 
&  3*v*v2**2*Conjg(Lam7) - 4*Tad1Loop(2))/(4._dp*v)
...
& Yu,epYU,Yd,Ye,epYD,epYE,M12,M112,M222,v,v2,Tad1Loop,TadpoleValues)
...
&  + 2._dp*(Lam4) + Lam5 + Conjg(Lam5))) + 3*v**2*v2*(Lam6 + Conjg(Lam6)) + v2*(-4._dp*(M12)& 
&  + v2**2*(Lam7 + Conjg(Lam7))))/4._dp - Tad1Loop(1),dp) 
TadpoleValues(2) = Real((4*M222*v2 + 2*Lam2*v2**3 + v**2*v2*(2._dp*(Lam3)             & 
&  + 2._dp*(Lam4) + Lam5 + Conjg(Lam5)) + v**3*(Lam6 + Conjg(Lam6)) + v*(-4._dp*(M12)    & 
&  + 3*v2**2*(Lam7 + Conjg(Lam7))))/4._dp - Tad1Loop(2),dp) 
