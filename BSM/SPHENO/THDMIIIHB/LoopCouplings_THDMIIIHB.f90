...
Module LoopCouplings_THDMIIIHB 
...
Real(dp) :: MAh2,MFe2(3),Mhh2(2),MHm2(2),Msigma12,MVWm2

Complex(dp) :: cplAhcHmVWm(2),cplcFeFeAhL(3,3),cplcFeFeAhR(3,3),cplcFeFehhL(3,3,2),cplcFeFehhR(3,3,2),& 
& cplcFeFesigma1L(3,3),cplcFeFesigma1R(3,3),cplcFeFvHmL(3,3,2),cplcFeFvHmR(3,3,2),       & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFvFecHmL(3,3,2),cplcFvFecHmR(3,3,2),           & 
& cplhhcHmVWm(2,2),cplhhcVWmVWm(2),cplsigma1cHmVWm(2)
...
chargefactor = 1 
  Do i2=1,3
If ((Msigma12.gt.mf_l2(2)).Or.(MFe2(i2).gt.mf_l2(2))) Then
coup1L = cplcFeFesigma1L(i2,gt1)
coup1R = cplcFeFesigma1R(i2,gt1)
coup2R = Conjg(cplcFeFesigma1L(i2,gt2))
coup2L = Conjg(cplcFeFesigma1R(i2,gt2))
sumI = sumI + chargefactor*0.5_dp*coup1L*coup2R*B1(0._dp,MFe2(i2),Msigma12)  
End if 
  End Do
...
Do i1= 1,3
  Do i2= 1,2
  If ((MFe2(i1).gt.mf_l2(2)).Or.(MHm2(i2).gt.mf_l2(2)).Or.(Msigma12.gt.mf_l2(2))) Then
coup1L = cplcFeFvHmL(i1,gt1,i2)
coup1R = cplcFeFvHmR(i1,gt1,i2)
coup2L = cplcFeFesigma1L(gt2,i1)
coup2R = cplcFeFesigma1R(gt2,i1)
coup3 = -cplsigma1cHmVWm(i2)
vertex = vertex + chargefactor*(0.5_dp*sqrt2*coup1L*coup2R*coup3*(MFe2(i1)*C0_3m(MFe2(i1),MHm2(i2),Msigma12) + B0(0._dp,MHm2(i2),Msigma12) +0.5_dp)) 
End if 
   End Do
  End Do
...
End Module LoopCouplings_THDMIIIHB 
