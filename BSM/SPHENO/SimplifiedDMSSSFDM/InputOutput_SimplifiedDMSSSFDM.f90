...
Case(4) 
  If (wert.ne.1) Calc3BodyDecay_Fre= .False. 
Case(1000) 
...
Case(1005) 
  If (wert.ne.1) CalcLoopDecay_Fre= .False. 
Case(1006) 
  If (wert.ne.1) CalcLoopDecay_ss= .False. 
Case(1101) 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 Write(io_L,102) INT(Abs(6000061)), Sqrt(mass_uncertainty_Q(1)**2+mass_uncertainty_Yt(1)**2),"# MFre(1) " 
 Write(io_L,102) INT(Abs(6666635)), Sqrt(mass_uncertainty_Q(3)**2+mass_uncertainty_Yt(3)**2),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(5)**2+mass_uncertainty_Yt(5)**2),"# Mhh(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 Write(io_L,102) INT(Abs(6000061)), mass_uncertainty_Q(1),"# MFre(1) " 
 Write(io_L,102) INT(Abs(6666635)), mass_uncertainty_Q(3),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(5),"# Mhh(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 Write(io_L,102) INT(Abs(6000061)), mass_uncertainty_Yt(1),"# MFre(1) " 
 Write(io_L,102) INT(Abs(6666635)), mass_uncertainty_Yt(3),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(5),"# Mhh(1) " 
End if
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,16:153)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,16:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,16:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,14:154)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,14:154)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,14:154)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,16:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,16:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,16:153)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFre 
CurrentPDG2(2) = -PDGFre 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh)//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFre)//"^* "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2=1, 3
...
If ((gTFre.gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BRFre(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
If (BRFre(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFre 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFre(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (Maxval(BRFre(1,7:6)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
End if 
...
If ((gTss.gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRss(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticless)//" -> "//Trim(NameParticless)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRss(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGss 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRss(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticless)//" -> "//Trim(NameParticless)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
If(gT1LFre.gt.MinWidth) Then 
Write(io_L,210) INT(PDGFre),gT1LFre,Trim(NameParticleFre) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BR1LFre(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGss 
Write(io_L,201) BR1LFre(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFre)//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticless)//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1Lss.gt.MinWidth) Then 
Write(io_L,210) INT(PDGss),gT1Lss,Trim(NameParticless) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
  Do gt2=1, 3
If (BR1Lss(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFre 
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BR1Lss(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticless)//" -> "//Trim(NameParticleFre)//"^* "//Trim(NameParticleFe(gt2))//" "//")"
Write(io_L,201) BR1Lss(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticless)//" -> "//Trim(NameParticleFre)//" "//Trim(NameParticleFe(gt2))//"^* "//")"
End if 
...
CurrentPDG2(1) = PDGss 
CurrentPDG2(2) = PDGhh 
Write(io_L,201) BR1Lss(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticless)//" -> "//Trim(NameParticless)//" "//Trim(NameParticlehh)//" "//")"
End if 
icount = icount +1 
If (BR1Lss(1,icount).Gt.BrMin) Then 
