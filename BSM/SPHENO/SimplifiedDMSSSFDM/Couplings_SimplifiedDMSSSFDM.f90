...
cplcFreFessR = 0._dp 
Do gt2 = 1, 3
Call CouplingcFreFess2LP(gt2,Ys,ZER,cplcFreFessL(gt2),cplcFreFessR(gt2))
...
cplcFeFressR = 0._dp 
Do gt1 = 1, 3
Call CouplingcFeFress2LP(gt1,Ys,ZER,cplcFeFressL(gt1),cplcFeFressR(gt1))
...
Subroutine CouplingcFreFess2LP(gt2,Ys,ZER,resL,resR)
...
End Subroutine CouplingcFreFess2LP  
 
 
Subroutine CouplingcFeFress2LP(gt1,Ys,ZER,resL,resR)
...
End Subroutine CouplingcFeFress2LP  
...
& cplcUFeFvcVWpL,cplcUFeFvcVWpR,cplcUFvFeHpL,cplcUFvFeHpR,cplcUFvFeVWpL,cplcUFvFeVWpR,   & 
& cplcUFvFvVZL,cplcUFvFvVZR,cplcFreFessL,cplcFreFessR,cplcFreFreVPL,cplcFreFreVPR,       & 
...
& cplcUFeFvcVWpL(3,3),cplcUFeFvcVWpR(3,3),cplcUFvFeHpL(3,3),cplcUFvFeHpR(3,3),           & 
& cplcUFvFeVWpL(3,3),cplcUFvFeVWpR(3,3),cplcUFvFvVZL(3,3),cplcUFvFvVZR(3,3),             & 
& cplcFreFessL(3),cplcFreFessR(3),cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,             & 
& cplcFreFreVZR,cplAhcHpVWp,cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),cplcFeFvcHpL(3,3),       & 
& cplcFeFvcHpR(3,3),cplcgZgWpcHp,cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,        & 
& cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,   & 
& cplHpHpcHpcHp,cplHpsssscHp,cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cplhhssss,        & 
& cplAhAhssss,cplhhhhssss,cplssssssss,cplAhAhhh,cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),       & 
...
& cplAhAhVZVZ,cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFeFehhL(3,3),cplcFeFehhR(3,3),       & 
& cplcFuFuhhL(3,3),cplcFuFuhhR(3,3),cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,      & 
& cplhhHpcVWp,cplhhcVWpVWp,cplhhVZVZ,cplhhhhhhhh,cplhhhhcVWpVWp,cplhhhhVZVZ,             & 
...
Subroutine CouplingsForVectorBosons(g1,TW,g2,v,ZDL,ZUL,ZEL,cplcFreFreVPL,             & 
...
Complex(dp), Intent(out) :: cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplAhcHpVWp,cplhhcHpVWp,      & 
...
res1 = res1-(g1**2*Sin(2._dp*(TW)))/4._dp
