...
& ZW,ZZ,v,g1,g2,g3,LS,LSH,Lam,Yu,Ys,Yd,Ye,MFS,MS2,mu2,kont)
...
& cplcFeFvcVWpR(3,3),cplcFreFessL(3),cplcFreFessR(3),cplcFreFreVPL,cplcFreFreVPR,        & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplcFuFuhhL(3,3),        & 
...
& cplcgGgGVG,cplcgWCgAcVWp,cplcgWCgWCAh,cplcgWCgWChh,cplcgWCgWCVP,cplcgWCgWCVZ,          & 
& cplcgWCgZcHp,cplcgWCgZcVWp,cplcgWpgWpAh,cplcgWpgWphh,cplcgWpgWpVP,cplcgWpgWpVZ,        & 
& cplcgWpgZHp,cplcgZgWCHp,cplcgZgWpcHp,cplcgZgWpcVWp,cplcgZgZhh,cplcHpVPVWp,             & 
& cplcHpVWpVZ,cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),cplcUFdFdhhL(3,3),cplcUFdFdhhR(3,3),   & 
...
& cplcUFeFeVZL(3,3),cplcUFeFeVZR(3,3),cplcUFeFressL(3),cplcUFeFressR(3),cplcUFeFvcHpL(3,3),& 
...
& cplhhhhcVWpVWp,cplhhhhhh,cplhhhhhhhh,cplhhhhHpcHp,cplhhhhssss,cplhhhhVZVZ,             & 
& cplhhHpcHp,cplhhHpcVWp,cplhhssss,cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVPVP,    & 
& cplHpcHpVPVZ,cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,cplHpcVWpVZ,cplHpHpcHpcHp,            & 
& cplHpsssscHp,cplssssssss,cplVGVGVG,cplVGVGVGVG1,cplVGVGVGVG2,cplVGVGVGVG3
...
& cplcUFeFvcVWpR,cplcUFvFeHpL,cplcUFvFeHpR,cplcUFvFeVWpL,cplcUFvFeVWpR,cplcUFvFvVZL,     & 
& cplcUFvFvVZR,cplcFreFessL,cplcFreFessR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,      & 
...
& cplhhhhcVWpVWp,cplhhhhVZVZ,cplcFdFdVGL,cplcFdFdVGR,cplcFuFuVGL,cplcFuFuVGR,            & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,v,g1,g2,g3,LS,LSH,Lam,Yu,Ys,Yd,Ye,MFS,MS2,              & 
& mu2,kont,ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,v,g1,g2,g3,LS,LSH,Lam,Yu,Ys,Yd,Ye,MFS,MS2,mu2,               & 
...
Call OneLoopFe(Ye,v,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,Mss,Mss2,MFre,MFre2,          & 
& MHp,MHp2,MVWp,MVWp2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,               & 
& cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFressL,cplcUFeFressR,       & 
& cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,cplcUFeFvcVWpR,0.1_dp*delta_mass,           & 
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_B1(p2,MFre2,Mss2),dp) 
B0m2 = MFre*Real(SA_B0(p2,MFre2,Mss2),dp) 
...
Subroutine DerSigma1LoopFe(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,Mss,Mss2,           & 
& MFre,MFre2,MHp,MHp2,MVWp,MVWp2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,    & 
& cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFressL,cplcUFeFressR,       & 
& cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,cplcUFeFvcVWpR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -Real(SA_DerB1(p2,MFre2,Mss2),dp) 
B0m2 = MFre*Real(SA_DerB0(p2,MFre2,Mss2),dp) 
coupL1 = cplcUFeFressL(gO1)
coupR1 = cplcUFeFressR(gO1)
coupL2 =  Conjg(cplcUFeFressL(gO2))
coupR2 =  Conjg(cplcUFeFressR(gO2))
...
mass = mi - 0.5_dp*(sigSL + sigSR)- 0.5_dp*MFre*(SigR+SigL) 
mass2= mass**2 
i_count = 0 
Do  
i_count = i_count + 1 
...
mass = mi - SigSR - 0.5_dp*MFre*(SigR+SigL) 
mass2= mass**2 
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -Real(SA_B1(p2,MFe2(i2),Mss2),dp) 
B0m2 = MFe(i2)*Real(SA_B0(p2,MFe2(i2),Mss2),dp) 
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -2._dp*Real(SA_B1(p2,MFre2,0._dp)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFre*Real(SA_B0(p2,MFre2,0._dp)-0.5_dp*rMS,dp) 
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -2._dp*Real(SA_B1(p2,MFre2,MVZ2)+ 0.5_dp*rMS,dp) 
B0m2 = -4._dp*MFre*Real(SA_B0(p2,MFre2,MVZ2)-0.5_dp*rMS,dp) 
...
Subroutine DerSigma1LoopFre(p2,Mss,Mss2,MFe,MFe2,MFre,MFre2,MVZ,MVZ2,cplcFreFessL,    & 
& cplcFreFessR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,sigL,             & 
& sigR,sigSL,sigSR)
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -Real(SA_DerB1(p2,MFe2(i2),Mss2),dp) 
B0m2 = MFe(i2)*Real(SA_DerB0(p2,MFe2(i2),Mss2),dp) 
coupL1 = cplcFreFessL(i2)
coupR1 = cplcFreFessR(i2)
coupL2 =  Conjg(cplcFreFessL(i2))
coupR2 =  Conjg(cplcFreFessR(i2))
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -2._dp*Real(SA_DerB1(p2,MFre2,MVP2)+ 0.5_dp*DerrMS,dp) 
B0m2 = -4._dp*MFre*Real(SA_DerB0(p2,MFre2,MVP2)-0.5_dp*DerrMS,dp) 
coupL1 = cplcFreFreVPL
coupR1 = cplcFreFreVPR
coupL2 =  Conjg(cplcFreFreVPL)
coupR2 =  Conjg(cplcFreFreVPR)
...
sumR = 0._dp 
sumL = 0._dp 
B1m2 = -2._dp*Real(SA_DerB1(p2,MFre2,MVZ2)+ 0.5_dp*DerrMS,dp) 
B0m2 = -4._dp*MFre*Real(SA_DerB0(p2,MFre2,MVZ2)-0.5_dp*DerrMS,dp) 
coupL1 = cplcFreFreVZL
coupR1 = cplcFreFreVZR
coupL2 =  Conjg(cplcFreFreVZL)
coupR2 =  Conjg(cplcFreFreVZR)
...
End Subroutine DerSigma1LoopFre 
...
If ((Include_in_loopFre).and.(Include_in_loopFe)) Then 
      Do i2 = 1, 3
 G0m2 = SA_Gloop(p2,MFre2,MFe2(i2)) 
B0m2 = -2._dp*MFre*MFe(i2)*SA_B0(p2,MFre2,MFe2(i2)) 
coupL1 = cplcFreFessL(i2)
coupR1 = cplcFreFessR(i2)
coupL2 =  Conjg(cplcFreFessL(i2))
coupR2 =  Conjg(cplcFreFessR(i2))
...
Subroutine DerPi1Loopss(p2,MFre,MFre2,MFe,MFe2,Mss,Mss2,Mhh,Mhh2,MAh,MAh2,            & 
& MHp,MHp2,cplcFreFessL,cplcFreFessR,cplhhssss,cplAhAhssss,cplhhhhssss,cplHpsssscHp,     & 
& cplssssssss,kont,res)
...
If ((Include_in_loopFre).and.(Include_in_loopFe)) Then 
      Do i2 = 1, 3
 G0m2 = SA_DerGloop(p2,MFre2,MFe2(i2)) 
B0m2 = -2._dp*MFre*MFe(i2)*SA_DerB0(p2,MFre2,MFe2(i2)) 
coupL1 = cplcFreFessL(i2)
coupR1 = cplcFreFessR(i2)
coupL2 =  Conjg(cplcFreFessL(i2))
coupR2 =  Conjg(cplcFreFessR(i2))
...
Subroutine Pi1LoopVP(p2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,MHp2,               & 
& MVWp,MVWp2,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFreFreVPL,              & 
& cplcFreFreVPR,cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWpVP,cplcgWCgWCVP,cplHpcHpVP,            & 
& cplHpcVWpVP,cplcVWpVPVWp,cplHpcHpVPVP,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,kont,res)

Implicit None 
Real(dp), Intent(in) :: MFd(3),MFd2(3),MFe(3),MFe2(3),MFre,MFre2,MFu(3),MFu2(3),MHp,MHp2,MVWp,MVWp2

Complex(dp), Intent(in) :: cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFreFreVPL,    & 
& cplcFreFreVPR,cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcgWpgWpVP,cplcgWCgWCVP,             & 
& cplHpcHpVP,cplHpcVWpVP,cplcVWpVPVWp,cplHpcHpVPVP,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,      & 
& cplcVWpVPVPVWp2
...
If (((.not.OnlyHeavyStates).and.(.not.OnlyLightStates)) & 
  & .or.((OnlyHeavyStates).and.(MFre2.gt.50._dp**2).and.(MFre2.gt.50._dp**2))   & 
  & .or.((OnlyLightStates).and.(MFre2.lt.50._dp**2).and.(MFre2.lt.50._dp**2)) )   Then 
H0m2 = Real(SA_Hloop(p2,MFre2,MFre2),dp) 
B0m2 = 4._dp*MFre*MFre*Real(SA_B0(p2,MFre2,MFre2),dp) 
coupL1 = cplcFreFreVPL
coupR1 = cplcFreFreVPR
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
...
Subroutine DerPi1LoopVP(p2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,MHp2,            & 
& MVWp,MVWp2,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFreFreVPL,              & 
& cplcFreFreVPR,cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWpVP,cplcgWCgWCVP,cplHpcHpVP,            & 
& cplHpcVWpVP,cplcVWpVPVWp,cplHpcHpVPVP,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,kont,res)
...
If (((.not.OnlyHeavyStates).and.(.not.OnlyLightStates)) & 
  & .or.((OnlyHeavyStates).and.(MFre2.gt.50._dp**2).and.(MFre2.gt.50._dp**2))   & 
  & .or.((OnlyLightStates).and.(MFre2.lt.50._dp**2).and.(MFre2.lt.50._dp**2)) )   Then 
H0m2 = Real(SA_DerHloop(p2,MFre2,MFre2),dp) 
B0m2 = 4._dp*MFre*MFre*Real(SA_DerB0(p2,MFre2,MFre2),dp) 
coupL1 = cplcFreFreVPL
coupR1 = cplcFreFreVPR
    SumI = (Abs(coupL1)**2+Abs(coupR1)**2)*H0m2 & 
                & + (Real(Conjg(coupL1)*coupR1,dp))*B0m2 
...
Subroutine DerPi1LoopVZ(p2,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFre,MFre2,            & 
& MFu,MFu2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVZL,cplcFuFuVZR,           & 
& cplcFvFvVZL,cplcFvFvVZR,cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,    & 
& cplcVWpVWpVZ,cplAhAhVZVZ,cplhhhhVZVZ,cplHpcHpVZVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,     & 
...
Subroutine Sigma1LoopFeMZ(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,Mss,Mss2,            & 
& MFre,MFre2,MHp,MHp2,MVWp,MVWp2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,    & 
& cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFressL,cplcUFeFressR,       & 
& cplcUFeFvcHpL,cplcUFeFvcHpR,cplcUFeFvcVWpL,cplcUFeFvcVWpR,sigL,sigR,sigSL,sigSR)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
If(gO1.eq.gO2) Then 
B1m2 = -Real(SA_B1(MFe2(gO1),MFre2,Mss2),dp) 
B0m2 = MFre*Real(SA_B0(MFe2(gO1),MFre2,Mss2),dp) 
Else 
B1m2 = -Real(SA_B1(p2,MFre2,Mss2),dp) 
B0m2 = MFre*Real(SA_B0(p2,MFre2,Mss2),dp) 
End If 
...
Subroutine Pi1LoopVPVZ(p2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,MHp2,             & 
...
& cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFreFreVPL,cplcFreFreVPR,        & 
& cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcFuFuVZL(3,3),        & 
& cplcFuFuVZR(3,3),cplcgWCgWCVP,cplcgWCgWCVZ,cplcgWpgWpVP,cplcgWpgWpVZ,cplcHpVPVWp,      & 
...
coupL1 = cplcFreFreVPL
coupR1 = cplcFreFreVPR
coupL2 = cplcFreFreVZL
coupR2 = cplcFreFreVZR
    SumI = (coupL1*coupL2+coupR1*coupR2)*H0m2 & 
                & + 0.5_dp*(coupL1*coupR2 + coupL2*coupR1)*B0m2 
res = res +1._dp* SumI  
End if 
...
Subroutine DerPi1LoopVPVZ(p2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,               & 
& MHp2,MVWp,MVWp2,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVPL,           & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,         & 
& cplcFreFreVZR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcgWCgWCVP,            & 
...
H0m2 = Real(SA_DerHloop(p2,MFre2,MFre2),dp) 
B0m2 = 2._dp*MFre*MFre*Real(SA_DerB0(p2,MFre2,MFre2),dp) 
coupL1 = cplcFreFreVPL
coupR1 = cplcFreFreVPR
coupL2 = cplcFreFreVZL
coupR2 = cplcFreFreVZR
