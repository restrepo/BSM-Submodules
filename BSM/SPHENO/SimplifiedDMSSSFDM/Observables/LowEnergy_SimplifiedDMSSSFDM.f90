...
Module LowEnergy_SimplifiedDMSSSFDM 
Use Control 
Use Settings 
...
a_mu = a_mu - Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/MFre& 
      & + (1._dp)*2._dp*MFe(Ifermion)*(Abs(coup1L)**2 + Abs(coup1R)**2)*F2(ratio)/MFre2 
End if 
...
& cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVZL(3,3),    & 
...
& cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplAhcHpVWp,cplhhcHpVWp,       & 
...
Complex(dp),Intent(in)  :: cplcFreFreVPL,cplcFreFreVPR,cplcFreFreVZL,cplcFreFreVZR,cplAhcHpVWp,cplhhcHpVWp,      & 
& cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,cplHpcHpVPVP,cplHpcHpcVWpVWp,            & 
& cplHpcHpVZVZ,cplAhhhVZ,cplAhHpcVWp,cplAhAhcVWpVWp,cplAhAhVZVZ,cplhhHpcVWp,             & 
...
Call Pi1LoopVZ(MVZ2,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,               & 
& MFu2,MVZ,MVZ2,MHp,MHp2,MVWp,MVWp2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,       & 
& cplcFeFeVZR,cplcFreFreVZL,cplcFreFreVZR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFvVZL,           & 
& cplcFvFvVZR,cplcgWpgWpVZ,cplcgWCgWCVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcVWpVWpVZ,   & 
& cplAhAhVZVZ,cplhhhhVZVZ,cplHpcHpVZVZ,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,  & 
...
Call Pi1LoopVPVZ(MVZ2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,MHp2,MVWp,            & 
...
Call Pi1LoopVP(MVZ2,MFd,MFd2,MFe,MFe2,MFre,MFre2,MFu,MFu2,MHp,MHp2,MVWp,              & 
...
End Function C1C2 
End Module LowEnergy_SimplifiedDMSSSFDM 
