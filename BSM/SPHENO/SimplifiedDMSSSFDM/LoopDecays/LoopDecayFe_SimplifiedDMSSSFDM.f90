...
Module OneLoopDecay_Fe_SimplifiedDMSSSFDM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFeAh


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFeAh(MLambda,em,gs,cplcFeFeAhL,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFeAh


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeAh


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeAh(MAh,MFe,Mhh,MHp,              & 
& MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,    & 
& cplAhhhVZ,cplAhHpcVWp,cplAhcHpVWp,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,     & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeAh


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeAh(MAh,MFe,Mhh,               & 
& MHp,MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFeFeAhL,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeAh


Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFehh(cplcFeFehhL,cplcFeFehhR,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFehh


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFehh(MLambda,em,gs,cplcFeFehhL,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFehh


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFehh(cplcFeFehhL,cplcFeFehhR,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFehh


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFehh(MAh,MFe,MFre,Mhh,             & 
...
! {Fre, ss, ss}
If ((Include_in_loopFre).and.(Include_in_loopss).and.(Include_in_loopss)) Then 
ML1 = MFre 
ML2 = Mss 
ML3 = Mss 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFehh


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFehh(MAh,MFe,MFre,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFehh


Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFeVZ


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,          & 
& cplcFeFeVZR,MFe,MVZ,GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFeVZ


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeVZ


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeVZ(MAh,MFe,MFre,Mhh,             & 
& MHp,Mss,MVP,MVWp,MVZ,MAh2,MFe2,MFre2,Mhh2,MHp2,Mss2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,       & 
...
& cplcFvFeHpL(3,3),cplcFvFeHpR(3,3),cplcFreFessL(3),cplcFreFessR(3),cplcFeFeVPL(3,3),    & 
& cplcFeFeVPR(3,3),cplcFvFeVWpL(3,3),cplcFvFeVWpR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplcFeFressL(3),cplcFeFressR(3),cplcFreFreVZL,cplcFreFreVZR,cplcFvFvVZL(3,3),          & 
& cplcFvFvVZR(3,3),cplcFeFvcHpL(3,3),cplcFeFvcHpR(3,3),cplcFeFvcVWpL(3,3),               & 
& cplcFeFvcVWpR(3,3),cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ
...
! {ss, bar[Fre], bar[Fre]}
If ((Include_in_loopss).and.(Include_in_loopFre).and.(Include_in_loopFre)) Then 
ML1 = Mss 
ML2 = MFre 
ML3 = MFre 
coup1L = cplcFeFressL(gt1)
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeVZ


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeVZ(MAh,MFe,MFre,              & 
& Mhh,MHp,Mss,MVP,MVWp,MVZ,MAh2,MFe2,MFre2,Mhh2,MHp2,Mss2,MVP2,MVWp2,MVZ2,               & 
& cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,     & 
& cplcFreFessL,cplcFreFessR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFressL,cplcFeFressR,cplcFreFreVZL,cplcFreFreVZR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeVZ


Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFress(cplcFeFressL,cplcFeFressR,     & 
...
Complex(dp), Intent(in) :: cplcFeFressL(3),cplcFeFressR(3)
...
Mex3 = Mss 
! Tree-Level Vertex 
coupT1L = cplcFeFressL(gt1)
coupT1R = cplcFeFressR(gt1)
Call TreeAmp_FtoFS(Mex1,Mex2,Mex3,coupT1L,coupT1R,AmpC) 
! Colour and symmetry factor 
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFress


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFress(MLambda,em,gs,cplcFeFressL,        & 
& cplcFeFressR,MFe,MFre,Mss,GammarealPhoton,GammarealGluon)
...
Mex3 = Mss
If (Mex1.gt.(Mex2+Mex3)) Then 
 Call hardradiationFFS(Mex1,Mex2,Mex3,MLambda,em,1._dp,1._dp,0._dp,1._dp,0._dp,0._dp,CoupL,CoupR,Gammarealphoton(i1),kont)
...
End if 
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFress


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFress(cplcFeFressL,cplcFeFressR,     & 
...
Complex(dp), Intent(in) :: ctcplcFeFressL(3),ctcplcFeFressR(3)
...
! Coupling counter term 
!----------------------------- 
ZcoupT1L = ctcplcFeFressL(gt1) 
ZcoupT1R = ctcplcFeFressR(gt1) 
!----------------------------- 
! Multiply Z-factors 
!----------------------------- 
! External Field 1 
Do i1=1,3
ZcoupT1L = ZcoupT1L + 0.5_dp*ZfER(i1,gt1)*cplcFeFressL(i1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(ZfEL(i1,gt1))*cplcFeFressR(i1)
End Do


! External Field 2 
ZcoupT1L = ZcoupT1L + 0.5_dp*Zfeu*cplcFeFressL(gt1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Conjg(Zfed)*cplcFeFressR(gt1)


! External Field 3 
ZcoupT1L = ZcoupT1L + 0.5_dp*Zfss*cplcFeFressL(gt1)
ZcoupT1R = ZcoupT1R + 0.5_dp*Zfss*cplcFeFressR(gt1)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFress


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFress(MFe,MFre,Mhh,Mss,            & 
...
! {Fe, hh, ss}
If ((Include_in_loopFe).and.(Include_in_loophh).and.(Include_in_loopss)) Then 
Do i1=1,3
ML1 = MFe(i1) 
ML2 = Mhh 
ML3 = Mss 
...
! {ss, bar[Fre], bar[Fe]}
If ((Include_in_loopss).and.(Include_in_loopFre).and.(Include_in_loopFe)) Then 
    Do i3=1,3
ML1 = Mss 
ML2 = MFre 
ML3 = MFe(i3) 
...
! {VP, bar[Fe], bar[Fre]}
If ((Include_in_loopVP).and.(Include_in_loopFe).and.(Include_in_loopFre)) Then 
  Do i2=1,3
ML1 = MVP 
ML2 = MFe(i2) 
ML3 = MFre 
...
! {VZ, bar[Fe], bar[Fre]}
If ((Include_in_loopVZ).and.(Include_in_loopFe).and.(Include_in_loopFre)) Then 
  Do i2=1,3
ML1 = MVZ 
ML2 = MFe(i2) 
ML3 = MFre 
...
End if 
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFress


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFress(MFe,MFre,Mhh,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFress


Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFvcHp(cplcFeFvcHpL,cplcFeFvcHpR,     & 
& MFe,MHp,MFe2,MHp2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFvcHp


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFvcHp(MLambda,em,gs,cplcFeFvcHpL,        & 
& cplcFeFvcHpR,MFe,MHp,GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFvcHp


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFvcHp(cplcFeFvcHpL,cplcFeFvcHpR,     & 
& ctcplcFeFvcHpL,ctcplcFeFvcHpR,MFe,MFe2,MHp,MHp2,ZfEL,ZfER,ZfHp,ZfvL,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFvcHp


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFvcHp(MAh,MFe,Mhh,MHp,             & 
& MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
& cplAhcHpVWp,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,Amp)
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFvcHp


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFvcHp(MAh,MFe,Mhh,              & 
& MHp,MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplAhcHpVWp,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,cplcHpVPVWp,cplcHpVWpVZ,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFvcHp


Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFvcVWp(cplcFeFvcVWpL,cplcFeFvcVWpR,  & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_SimplifiedDMSSSFDM_FeToFvcVWp


Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFvcVWp(MLambda,em,gs,cplcFeFvcVWpL,      & 
& cplcFeFvcVWpR,MFe,MVWp,GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_SimplifiedDMSSSFDM_FeToFvcVWp


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFvcVWp(cplcFeFvcVWpL,cplcFeFvcVWpR,  & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFvcVWp


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFvcVWp(MAh,MFe,Mhh,MHp,            & 
& MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,              & 
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFvcVWp


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFvcVWp(MAh,MFe,Mhh,             & 
& MHp,MVP,MVWp,MVZ,MAh2,MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,          & 
& cplAhHpcVWp,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFvFvVZL,cplcFvFvVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,           & 
& cplcFeFvcVWpR,cplhhHpcVWp,cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,cplcVWpVPVWp,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFvcVWp


Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,        & 
& cplcFeFeVZL,cplcFeFeVZR,ctcplcFeFeVPL,ctcplcFeFeVPR,ctcplcFeFeVZL,ctcplcFeFeVZR,       & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_SimplifiedDMSSSFDM_FeToFeVP


Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeVP(MAh,MFe,MFre,Mhh,             & 
& MHp,Mss,MVP,MVWp,MVZ,MAh2,MFe2,MFre2,Mhh2,MHp2,Mss2,MVP2,MVWp2,MVZ2,cplcFeFeAhL,       & 
...
& cplcFeFvcVWpL(3,3),cplcFeFvcVWpR(3,3),cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,              & 
& cplcVWpVPVWp
...
End if 
  End Do
End Do
End Subroutine Amplitude_VERTEX_SimplifiedDMSSSFDM_FeToFeVP


Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeVP(MAh,MFe,MFre,              & 
& Mhh,MHp,Mss,MVP,MVWp,MVZ,MAh2,MFe2,MFre2,Mhh2,MHp2,Mss2,MVP2,MVWp2,MVZ2,               & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,               & 
& cplcFreFessL,cplcFreFessR,cplcFeFeVPL,cplcFeFeVPR,cplcFvFeVWpL,cplcFvFeVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFressL,cplcFeFressR,cplcFreFreVPL,cplcFreFreVPR,         & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplHpcHpVP,cplHpcVWpVP,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FeToFeVP



End Module OneLoopDecay_Fe_SimplifiedDMSSSFDM
