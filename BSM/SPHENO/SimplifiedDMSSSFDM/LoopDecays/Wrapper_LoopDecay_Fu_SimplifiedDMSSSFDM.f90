...
Module Wrapper_OneLoopDecay_Fu_SimplifiedDMSSSFDM
Use Model_Data_SimplifiedDMSSSFDM 
Use Kinematics 
Use OneLoopDecay_Fu_SimplifiedDMSSSFDM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Fu(MFdOS,MFd2OS,MFuOS,MFu2OS,MFeOS,MFe2OS,MFreOS,             & 
...
& cplHpcVWpVZ,cplVGVGVG,ctcplcFuFdHpL,ctcplcFuFdHpR,ctcplcFuFdVWpL,ctcplcFuFdVWpR,       & 
& ctcplcFuFuAhL,ctcplcFuFuAhR,ctcplcFuFuhhL,ctcplcFuFuhhR,ctcplcFuFuVGL,ctcplcFuFuVGR,   & 
& ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,GcplcFuFdHpL,GcplcFuFdHpR,     & 
...
& ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFucHpL,ZcplcFdFucHpR,       & 
...
& ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZR,ZcplcHpVPVWp,ZcplcVWpVPVWp,        & 
...
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,           & 
& MFd,MFu,MVWp,MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)

  Else 
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFdVWp(ZcplcFuFdVWpL,ZcplcFuFdVWpR,         & 
& MFd,MFu,MVWp,MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,              & 
& cplcFuFdVWpR,MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFdVWp(MLambda,em,gs,ZcplcFuFdVWpL,             & 
& ZcplcFuFdVWpR,MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,              & 
& cplcFuFdVWpR,MFd,MFu,MVWp,MRPFuToFdVWp,MRGFuToFdVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFdVWp(MLambda,em,gs,ZcplcFuFdVWpL,             & 
& ZcplcFuFdVWpR,MFd,MFu,MVWp,MRPFuToFdVWp,MRGFuToFdVWp)
...
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,           & 
& ctcplcFuFdVWpL,ctcplcFuFdVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,             & 
& ZfUR,ZfVWp,AmpWaveFuToFdVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,            & 
& MVG,MVP,MVWp,MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,            & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhcHpVWp,cplcFdFdhhL,cplcFdFdhhR,               & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,             & 
...
& AmpVertexIRdrFuToFdVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFdVWp(MAhOS,MFdOS,MFuOS,              & 
& MhhOS,MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,              & 
& MVP2,MVWp2OS,MVZ2OS,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhcHpVWp,       & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplhhcHpVWp,cplhhcVWpVWp,GosZcplcHpVPVWp,cplcVWpVPVWp,         & 
& cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRosFuToFdVWp)
...
& ZcplcFuFdVWpL,ZcplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplhhcHpVWp,cplhhcVWpVWp,GZcplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,          & 
...
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZR,cplhhcHpVWp,cplhhcVWpVWp,GcplcHpVPVWp,cplcVWpVPVWp,            & 
& cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRosFuToFdVWp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,              & 
& MFu,Mhh,MFu2,Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,            & 
& MFu,Mhh,MFu2,Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,    & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,               & 
& ZcplcFuFuhhR,MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
& MFu,Mhh,MRPFuToFuhh,MRGFuToFuhh)
 ...
 ! DR and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,               & 
& ZcplcFuFuhhR,MFu,Mhh,MRPFuToFuhh,MRGFuToFuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,              & 
& ctcplcFuFuhhL,ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,MVG,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,             & 
...
& cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRdrFuToFuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFuhh(MAhOS,MFdOS,MFuOS,               & 
& MhhOS,MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,              & 
...
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
& cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,cplcFdFucHpR,             & 
& cplcFdFucVWpL,cplcFdFucVWpR,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,              & 
& cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRosFuToFuhh)
...
i4 = isave 
  Do gt2=1,3
If (((OSkinematics).and.(MFuOS(gt1).gt.(MFuOS(gt2)+MhhOS))).or.((.not.OSkinematics).and.(MFu(gt1).gt.(MFu(gt2)+Mhh)))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*) gt1, gt2 
  AmpSum2FuToFuhh = AmpTreeFuToFuhh
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 2._dp 
If (AmpSqFuToFuhh(gt1, gt2).le.0._dp) Then 
  gP1LFu(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,              & 
& MFu,MVZ,MFu2,MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_SimplifiedDMSSSFDM_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,            & 
& MFu,MVZ,MFu2,MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,    & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,               & 
& ZcplcFuFuVZR,MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
& MFu,MVZ,MRPFuToFuVZ,MRGFuToFuVZ)
 ...
 ! DR and Z-factors 
Call Gamma_Real_SimplifiedDMSSSFDM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,               & 
& ZcplcFuFuVZR,MFu,MVZ,MRPFuToFuVZ,MRGFuToFuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,              & 
& cplcFuFuVZL,cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,       & 
& MFu,MFu2,MVP,MVP2,MVZ,MVZ2,ZfUL,ZfUR,ZfVPVZ,ZfVZ,AmpWaveFuToFuVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,MVG,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,             & 
& MVG,MVP,MVWp,MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,            & 
...
& cplcVWpVWpVZ,AmpVertexIRdrFuToFuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SimplifiedDMSSSFDM_FuToFuVZ(MAhOS,MFdOS,MFuOS,               & 
& MhhOS,MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,              & 
& MVP2,MVWp2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplcFuFdHpL,cplcFuFdHpR,         & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,cplcFuFuhhR,             & 
...
& cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRosFuToFuVZ)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,            & 
& ctcplcFuFuVGL,ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,              & 
& ctcplcFuFuVGL,ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,            & 
& MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,               & 
& MVWp2OS,MVZ2OS,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFdHpL,ZcplcFuFdHpR,ZcplcFdFdVGL,       & 
...
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,            & 
& MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,               & 
& MVWp2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,            & 
...
& cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplVGVGVG,AmpVertexFuToFuVG)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,              & 
& ctcplcFuFuVGL,ctcplcFuFuVGR,MFu,MFu2,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)



!Vertex Corrections 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVG(MAh,MFd,MFu,Mhh,MHp,MVG,            & 
& MVP,MVWp,MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,            & 
& ZcplcFuFuVZL,ZcplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,     & 
& MFuOS,MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)

 Else 
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,              & 
& cplcFuFuVZL,cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,       & 
& MFuOS,MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,            & 
& MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,               & 
& MVWp2OS,MVZ2OS,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFdHpL,ZcplcFuFdHpR,ZcplcFdFdVPL,       & 
...
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,            & 
& MHpOS,MVG,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,               & 
& MVWp2OS,MVZ2OS,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVPL,            & 
& cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,             & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcFdFucHpL,              & 
& cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,           & 
& cplcVWpVPVWp,AmpVertexFuToFuVP)
...
Call Amplitude_WAVE_SimplifiedDMSSSFDM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,              & 
& cplcFuFuVZL,cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,       & 
& MFu,MFu2,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)



!Vertex Corrections 
Call Amplitude_VERTEX_SimplifiedDMSSSFDM_FuToFuVP(MAh,MFd,MFu,Mhh,MHp,MVG,            & 
& MVP,MVWp,MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
...
End Module Wrapper_OneLoopDecay_Fu_SimplifiedDMSSSFDM
