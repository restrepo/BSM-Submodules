...
Module CouplingsCT_SimplifiedDMSSSFDM
...
& ZER,Yu,ZUL,ZUR,Ys,dLam,dv,dLSH,dg1,dg2,dSinTW,dCosTW,dTanTW,dg3,dYd,dZDL,              & 
& dZDR,dYe,dZEL,dZER,dYu,dZUL,dZUR,dYs,ctcplAhAhhh,ctcplhhhhhh,ctcplhhHpcHp,             & 
...
Implicit None 
Real(dp), Intent(in) :: v,g1,g2,TW,g3,Ys(3),dv,dg1,dg2,dSinTW,dCosTW,dTanTW,dg3,dYs(3)
...
ctcplcFreFessL = 0._dp 
ctcplcFreFessR = 0._dp 
Do gt2 = 1, 3
Call CT_CouplingcFreFess(gt2,Ys,ZER,dYs,dZER,ctcplcFreFessL(gt2),ctcplcFreFessR(gt2))

End Do 


ctcplcFeFressL = 0._dp 
ctcplcFeFressR = 0._dp 
Do gt1 = 1, 3
Call CT_CouplingcFeFress(gt1,Ys,ZER,dYs,dZER,ctcplcFeFressL(gt1),ctcplcFeFressR(gt1))
...
ctcplcFreFreVPL = 0._dp 
ctcplcFreFreVPR = 0._dp 
Call CT_CouplingcFreFreVP(g1,TW,dg1,dSinTW,dCosTW,dTanTW,ctcplcFreFreVPL,             & 
& ctcplcFreFreVPR)



ctcplcFreFreVZL = 0._dp 
ctcplcFreFreVZR = 0._dp 
Call CT_CouplingcFreFreVZ(g1,TW,dg1,dSinTW,dCosTW,dTanTW,ctcplcFreFreVZL,             & 
& ctcplcFreFreVZR)
...
Subroutine CT_CouplingcFreFess(gt2,Ys,ZER,dYs,dZER,resL,resR)

Implicit None 

Integer, Intent(in) :: gt2
Real(dp), Intent(in) :: Ys(3),dYs(3)

Complex(dp), Intent(in) :: ZER(3,3),dZER(3,3)

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CT_CouplingcFreFess' 
...
resR = 0._dp 
Do j1 = 1,3
resR = resR-(dYs(j1)*ZER(gt2,j1))
End Do 
Do j1 = 1,3
resR = resR-(dZER(gt2,j1)*Ys(j1))
End Do 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
...
End Subroutine CT_CouplingcFreFess  
 
 
Subroutine CT_CouplingcFeFress(gt1,Ys,ZER,dYs,dZER,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CT_CouplingcFeFress' 
...
resL = 0._dp 
Do j1 = 1,3
resL = resL-(Conjg(ZER(gt1,j1))*dYs(j1))
End Do 
Do j1 = 1,3
resL = resL-(Conjg(dZER(gt1,j1))*Ys(j1))
End Do 
resR = 0._dp 
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
...
End Subroutine CT_CouplingcFeFress  
...
Subroutine CT_CouplingcFreFreVP(g1,TW,dg1,dSinTW,dCosTW,dTanTW,resL,resR)

Implicit None 

Real(dp), Intent(in) :: g1,TW,dg1,dSinTW,dCosTW,dTanTW

Complex(dp), Intent(out) :: resL, resR 
 
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CT_CouplingcFreFreVP' 
 
resL = 0._dp 
resL = resL+dCosTW*g1
resL = resL+dg1*Cos(TW)
resR = 0._dp 
resR = resR+dCosTW*g1
resR = resR+dg1*Cos(TW)
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
...
End Subroutine CT_CouplingcFreFreVP  
 
 
Subroutine CT_CouplingcFreFreVZ(g1,TW,dg1,dSinTW,dCosTW,dTanTW,resL,resR)
...
Integer :: j1,j2,j3,j4,j5,j6, j7, j8, j9, j10, j11, j12 
Iname = Iname +1 
NameOfUnit(Iname) = 'CT_CouplingcFreFreVZ' 
 
resL = 0._dp 
resL = resL-(dSinTW*g1)
resL = resL-(dg1*Sin(TW))
resR = 0._dp 
resR = resR-(dSinTW*g1)
resR = resR-(dg1*Sin(TW))
If ((Real(resL,dp).ne.Real(resL,dp)).or.(Real(resR,dp).ne.Real(resR,dp))) Then 
...
End Subroutine CT_CouplingcFreFreVZ  
...
End Module CouplingsCT_SimplifiedDMSSSFDM 
