...
Module Model_Data_SimplifiedDMSSSFDM 
...
Logical, Save :: CalcLoopDecay_Fre=.True.
Logical, Save :: CalcLoopDecay_ss=.True.
Logical, Save :: Calc3BodyDecay_Fu=.True.
Logical, Save :: Calc3BodyDecay_Fe=.True.
Logical, Save :: Calc3BodyDecay_Fd=.True.
Logical, Save :: Calc3BodyDecay_Fre=.True.
...
Complex(dp) :: LSIN,LSHIN,LamIN,YuIN(3,3),YdIN(3,3),YeIN(3,3),MFSIN,mu2IN

Real(dp) :: g1MZ,g2MZ,g3MZ,YsMZ(3),MS2MZ

Complex(dp) :: LSMZ,LSHMZ,LamMZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3),MFSMZ,mu2MZ

Real(dp) :: g1GUT,g2GUT,g3GUT,YsGUT(3),MS2GUT

Complex(dp) :: LSGUT,LSHGUT,LamGUT,YuGUT(3,3),YdGUT(3,3),YeGUT(3,3),MFSGUT,mu2GUT
...
Real(dp) :: gPFu(3,153),gTFu(3),BRFu(3,153),gPFe(3,154),gTFe(3),BRFe(3,154),gPFd(3,153),          & 
& gTFd(3),BRFd(3,153),gPhh(1,50),gThh,BRhh(1,50),gPFre(1,6),gTFre,BRFre(1,6),            & 
& gPss(1,6),gTss,BRss(1,6)

Real(dp) :: gP1LFu(3,15),gT1LFu(3),BR1LFu(3,15),gP1LFe(3,13),gT1LFe(3),BR1LFe(3,13),              & 
& gP1LFd(3,15),gT1LFd(3),BR1LFd(3,15),gP1Lhh(1,50),gT1Lhh,BR1Lhh(1,50),gP1LFre(1,6),     & 
& gT1LFre,BR1LFre(1,6),gP1Lss(1,6),gT1Lss,BR1Lss(1,6)
...
& g2,g3,LS,LSH,Lam,Yu,Ys,Yd,Ye,MFS,MS2,mu2,MZsuffix)
...
End Module Model_Data_SimplifiedDMSSSFDM