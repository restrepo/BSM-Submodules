...
& Laminput,Yuinput,Ydinput,Yeinput,Muinput,vinput,cplcFuFdVWpL,cplcFuFdVWpR,             & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,Muinput,vinput,cplcFeFehhL,cplcFeFehhR,               & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,Muinput,vinput,cplcFdFdhhL,cplcFdFdhhR,               & 
...
& MHp2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,ZDRinput,ZERinput,           & 
& ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,g2input,g3input,           & 
& Laminput,Yuinput,Ydinput,Yeinput,Muinput,vinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,  & 
