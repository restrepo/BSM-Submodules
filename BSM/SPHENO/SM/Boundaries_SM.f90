...
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,               & 
& g2,g3,Lam,Yu,Yd,Ye,Mu,delta0,gMZ,kont)
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,MHp,MVWp,MFd,MFu,MFe) 
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MFe,Mhh,MHp,ZER,ZEL,Ye,delta)
...
Call ParametersToG61(g1,g2,g3,Lam,Yu,Yd,Ye,Mu,gMZ)
...
& g3,Lam,Yu,Yd,Ye,Mu,mGut,kont,WriteComment,niter)
